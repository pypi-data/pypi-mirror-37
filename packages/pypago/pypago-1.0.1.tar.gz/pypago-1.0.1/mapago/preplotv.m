function [atracer, zvect, lvect, atracer_pcol, zvect_pcol, lvect_pcol] = preplotv(secstruct, secdata)
%PREPLOTV
% DESCRIPTION
%
% Warning: nodouble_v is based on the assumption that when 2 velocities are
% used in 1 gridcell, the resulting velocity
%
% EXAMPLES
%
%   See also NODOUBLE_V NODOUBLE_TSR PREPLOTV FIGURE_SECTION_1L
%
%
%MAPAGO Toolbox.
...
for z=1:nz
    atracer(z, :) = nodouble_v(secstruct.veci, secstruct.vecj, secdata(z, :));
