...
- addBtn (string; optional): The id of add button
- cell (string; optional): The target cell type
- clickData (dict; optional): Data from latest click event

Available events: """
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, graph=Component.UNDEFINED, addBtn=Component.UNDEFINED, cell=Component.UNDEFINED, clickData=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'graph', 'addBtn', 'cell', 'clickData']
        self._type = 'TableInfo'
        self._namespace = 'dashx'
        self._valid_wildcard_attributes =            []
        self.available_events = []
        self.available_properties = ['id', 'graph', 'addBtn', 'cell', 'clickData']
