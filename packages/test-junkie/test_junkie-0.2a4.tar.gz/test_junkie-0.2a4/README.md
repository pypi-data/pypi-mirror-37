...
`Meta.update()` takes 3 positional arguments:
- `test`: this is the current test function that is running the test.
...
def a_test(self):
    ...
    Meta.update(test=self, name="new test name", expected="updated expectation")
    ...
    
@test(parameters=[1, 2, 3])
def b_test(self, parameter):
    ...
    Meta.update(test=self, parameter=parameter, 
...
def c_test(self, parameter, suite_parameter):
    ...
    Meta.update(test=self, parameter=parameter, suite_parameter=suite_parameter,
                name="new test name", expected="updated expectation") 
    ...
```
