...
setup(
    ...
    description='Plugin to use Gctf program within the Scipion framework',  # Required
    ...
    url='https://github.com/scipion-em/scipion-em-gctf',  # Optional
