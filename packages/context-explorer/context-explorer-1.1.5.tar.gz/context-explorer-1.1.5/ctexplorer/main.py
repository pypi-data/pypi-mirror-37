...
#             self.data[new_col_name] = self.data[new_col_name].str.join('')
    ...
    def cluster_cells_multicpu_wrapper(self):
        ...
        self.cluster_params['min_samples'] = float(self.lineEdit_min_pts.text())
        ...
        self.cluster_params['min_density'] = float(self.lineEdit_min_density.text())
        self.cluster_params['max_density'] = float(self.lineEdit_max_density.text())
        self.cluster_params['min_roundness'] = float(self.lineEdit_min_roundness.text())
        self.cluster_params['max_roundness'] = float(self.lineEdit_max_roundness.text())
        self.well_colony_vertices = cluster_cells_multicpu(self, self.cluster_params)
        self.update_column_combo_boxes()
        return None
...
#                self.plot_colony_clusters_wrapper())
    ...
    #        self.clustering_window.pushButton_plot.clicked.connect(self.plot_colony_clusters_wrapper())
            ...
            # Assign plot parameters from the GUI
