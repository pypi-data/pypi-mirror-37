...
def plot_hexbins(ax, fig, cond_name, cond_df, hb_params):
    '''
    TODO will probably be a hexbin and line bin sectino in the same function
    instead easier for multiCPU. Not since I have the wrapper function?
    '''
    hb = ax.hexbin(
    ...
    # fig.colorbar(hb)  # this is for changing the colorbar
    pass
