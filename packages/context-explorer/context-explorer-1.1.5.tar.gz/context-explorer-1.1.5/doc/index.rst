...
`pypi.org`_ (3), and how to build a ``conda`` package (4-6) and upload it to
`anaconda.org`_ (7).
...
3. Upload the package to PyPI.org.
    ...
    .. code:: python
        ...
        twine upload dist/context-explorer-<major.minor.path>.tar.gz
...
6. The conda package is usually created in
   ``~anaconda3/conda-bld/linux-64/<pacakge_name>`` and can be converted to
