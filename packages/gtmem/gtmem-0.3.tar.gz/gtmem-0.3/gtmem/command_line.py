...
def main():
  ...
  last_import_at = (user.query(f'query{{Locations(order: timestamp_desc first: 1 source: "{source}"){{timestamp}}}}')['data']['Locations'] or [{'timestamp': '1970-01-01 00:00:00'}])[0].get('timestamp')
