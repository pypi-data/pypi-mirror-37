...
class Scenario:
    ...
    def remove_obstacle(self, obstacle: Obstacle):
        """ Removes a static or dynamic obstacle from the scenario. If the obstacle ID is not assigned,
        a warning message is given.

        :param obstacle: obstacle to be removed
        """
        assert isinstance(obstacle, Obstacle), '<Scenario/remove_obstacle> argument "obstacle" of wrong type. ' \
    ...
    def obstacles_by_position_intervals(
            ...
            obstacle_role: Tuple[ObstacleRole] = (ObstacleRole.DYNAMIC, ObstacleRole.STATIC)) -> List[Obstacle]:
        """
