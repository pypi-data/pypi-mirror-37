...
@click.option('--url', '-u', required=True, help='Vault url (with port)')
@click.option('--token', '-t', required=True, help='Vault token')
@click.option('--prefix', '-r', required=False, help='Vault prefix, if exist')
@click.option('--private', '-p', required=False, help='Whether vault is private or not')
@click.option('--inheritable', '-i', required=False, help='Whether vault Values are Inheritable or not')
@click.option('--source-kitchen', '-o', required=False, help='Source Kitchen to inherit')
@click.pass_obj
def vault_config(backend, kitchen, service, url, token, prefix, private, inheritable, source_kitchen):
    """
    ...
    Examples:
        ...
        dk vault-config --kitchen my-kitchen \\
            ...
            --inheritable True \\
            --source-kitchen my-source-kitchen \\
...
@click.pass_obj
def vault_delete(backend, kitchen):
    """
