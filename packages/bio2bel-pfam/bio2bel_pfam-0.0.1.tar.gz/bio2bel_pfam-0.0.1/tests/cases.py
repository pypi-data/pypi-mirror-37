...
class TemporaryCacheClass(AbstractTemporaryCacheClassMixin):
    """A test case containing a temporary database and a Bio2BEL PFAM manager."""
    ...
    @classmethod
    def populate(cls):
        """Populate the Bio2BEL PFAM database with test data."""
