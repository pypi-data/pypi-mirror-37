...
def upgrade():
    ...
    sa.Column('time_updated', sa.DateTime(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=True),
    sa.ForeignKeyConstraint(['user_uuid'], ['USERS.uuid'], name=op.f('fk_USER_ATTRIBUTES_user_uuid_USERS'), onupdate='CASCADE', ondelete='CASCADE'),
    ...
    sa.Column('time_updated', sa.DateTime(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=True),
    sa.ForeignKeyConstraint(['user_uuid'], ['USERS.uuid'], name=op.f('fk_USER_LOGINS_user_uuid_USERS'), onupdate='CASCADE', ondelete='CASCADE'),
