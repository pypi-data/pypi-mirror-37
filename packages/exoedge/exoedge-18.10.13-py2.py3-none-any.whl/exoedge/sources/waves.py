...
def _apply_adsr(value,
    ...
    def _mapper(x, in_min, in_max, out_min, out_max):
    ...
    if stage <= attack:
        ...
        gain = _mapper(stage, attack + decay + sustaint, attack + decay + sustaint + release, sustainl, 0)
