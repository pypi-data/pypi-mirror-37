...
from vmware.vapi.client.dcli.exceptions import (
    handle_error, handle_ssl_error, ParsingExit)
...
def prompt_for_credentials(server_type, username=None, credstore_add=None):
    """
    ...
    if server_type in (ServerTypes.VMC, ServerTypes.NSX):
        username = CliOptions.VMC_DUMMY_CREDSTORE_USER
