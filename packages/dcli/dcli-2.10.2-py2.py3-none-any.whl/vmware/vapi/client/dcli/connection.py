...
class CliConnection(object):  # pylint: disable=R0902
    ...
    def handle_user_and_password_input(self):
        ...
        """
        username, password, should_save = prompt_for_credentials(self.server_type, username=self.username, credstore_add=self.credstore_add)
