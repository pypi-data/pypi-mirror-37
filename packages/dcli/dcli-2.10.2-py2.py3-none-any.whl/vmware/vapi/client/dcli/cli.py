...
class CliMain(object):
    ...
    def process_input(self, cmd_input, parser, parsed_args=None, fp=sys.stdout):
        ...
        status_code = self.handle_basic_params(cli_client_args, parser)
    ...
    def handle_basic_params(self, cli_client_args, parser):
        """
        ...
        if cli_client_args.credstore_list:
            ...
            return credstore.list(self.formatter)
    ...
    def remove_credstore_entry(self, session_manager):
        ...
        if remove_from_connection['type'] in (ServerTypes.NSX, ServerTypes.VMC):
            credstore_server = CliOptions.DCLI_VMC_SERVER
        else:
            credstore_server = remove_from_connection['address']
