...
class AppStatusMaintainer:
    on_instance_update_status = Signal()
    ...
    def update_status(self, app_instance_identifier: AppInstanceIdentifier, status: str, script_name: str):
        ...
        self.on_instance_update_status.send(self, identifier=app_instance_identifier, script_name=script_name)
