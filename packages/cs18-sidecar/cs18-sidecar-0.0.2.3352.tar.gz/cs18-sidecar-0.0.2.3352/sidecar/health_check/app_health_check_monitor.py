...
class AppHealthCheckMonitor:
    ...
    def _test_public_network(self, identifier: AppInstanceIdentifier, script_name: str):
        ...
        try:
            required_public_access = self._app_service.open_firewall_access_to_instances(identifier=identifier)

            if required_public_access:
    ...
    def _test_private_network(self, identifier: AppInstanceIdentifier, script_name: str) -> bool:
