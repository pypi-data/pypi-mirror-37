...
class SidecarApplication:
    def __init__(self, name: str,
        ...
        # if not healthcheck_script and not default_health_check_ports_to_test:
        #     raise Exception('At least one of the following health-check policy must be specified: healthcheck_script, '
