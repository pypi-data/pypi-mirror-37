...
class AppHealthCheckMonitor:
    ...
    @CallsLogger.wrap
    def start(self, identifier: AppIdentifier, infra_id: str):
        ...
        try:
            ...
            if app_configuration_status \
                ...
                self._start(identifier=identifier, infra_id=infra_id)
            else:
    ...
    def _start(self, identifier: AppIdentifier, infra_id: str):
    ...
    def _test_private_network(self, identifier: AppIdentifier, infra_id: str) -> bool:
