...
class AppService:
    ...
    @abstractmethod
    def open_firewall_access_to_instances(self, identifier: AppInstanceIdentifier) -> bool:
        """
...
class AWSAppService(AppService):
    ...
    def open_firewall_access_to_instances(self, identifier: AppInstanceIdentifier) -> bool:
        ...
        with self._lock:  # restrict to 1 instance at the time
            ...
            if AwsTagHelper.safely_get_tag(instance, Const.EXTERNAL_ELB_DNS_NAME, logger=self._logger):
                elb = self._get_auto_scaling_group_elb(instance)
                security_group_ids = elb['SecurityGroups']
    ...
    def _get_auto_scaling_group_elb(self, instance: Instance) -> Optional[str]:
        ...
        if autoscaling_group_name:
            ...
            elb_response = self._session.get_elb_client() \
                .describe_load_balancers(LoadBalancerNames=[load_balancer_name])
            return elb_response['LoadBalancerDescriptions'][0]
