...
def run_impl(config: ISidecarConfiguration):
    ...
    aws_session = None
    if config is AwsSidecarConfiguration:
        aws_config = config  # type: AwsSidecarConfiguration
...
def configure_debug() -> ISidecarConfiguration:
    global _kub_token_provider
    ...
    return KubernetesSidecarConfiguration(environment="test",
