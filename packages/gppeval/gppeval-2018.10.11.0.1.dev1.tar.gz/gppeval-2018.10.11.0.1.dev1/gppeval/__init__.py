...
__version_info__ = (2018, 10, 11, 0, 1, 'dev1')
        ...
        if type(gpp) is GeothermalPowerPlant:
            ...
            if gpp.volume['pdf'] is None:
                ...
                gpp.power_potential['pdf'] = gpp.power_energy(tr, ta, phi, cr, cf, rho_r,
                                                              rho_f, rf, ce, pf, t, a, h, None, rtype)
            else:
                v = self.probability_distribution_function(gpp.volume)
                gpp.power_potential['pdf'] = gpp.power_energy(tr, ta, phi, cr, cf, rho_r,
                                                              rho_f, rf, ce, pf, t, None,
                                                              None, v, rtype)
            ...
            if gpp.area['pdf'] is None or gpp.thickness['pdf'] is None:
                print 'ERROR: PDF of both Area and Thickness must be valid distribution' \
                      + ': T, N, C, U, L\n SIMULATION ... FAILURE !'
            else:
