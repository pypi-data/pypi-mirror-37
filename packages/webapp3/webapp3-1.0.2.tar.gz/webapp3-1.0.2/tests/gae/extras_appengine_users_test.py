...
import webapp3
from webapp3_extras.appengine import users
...
class LoginRequiredHandler(webapp3.RequestHandler):
...
class AdminRequiredHandler(webapp3.RequestHandler):
...
class TestUsers(test_base.BaseTestCase):
    def test_login_required_allowed(self):
        ...
        req = webapp3.Request.blank('/login_required')
    ...
    def test_admin_required_allowed(self):
        ...
        req = webapp3.Request.blank('/admin_required')
