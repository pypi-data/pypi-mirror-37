...
class TestRequest(BaseTestCase):
    def test_charset(self):
        req = webapp3.Request.blank('/', environ={
        ...
        match = webapp3._charset_re.search('text/html')
        if match:
        ...
        match = webapp3._charset_re.search('text/html; charset=ISO-8859-4')
        if match:
            charset = match.group(1).lower().strip().strip('"').strip()
        else:
            charset = 'utf-8'
        ...
        match = webapp3._charset_re.search(
    ...
    def test_unicode(self):
        req = webapp3.Request.blank('/?1=2', POST='3=4')
    ...
    def test_cookie_unicode(self):
        ...
        value = webapp3._to_basestring(base64.b64encode(u'á'.encode('utf-8')))
        rsp = webapp3.Response()
        rsp.set_cookie('foo', value)

        cookie = rsp.headers.get('Set-Cookie')
        req = webapp3.Request.blank('/', headers=[('Cookie', cookie)])
    ...
    def test_get(self):
        req = webapp3.Request.blank('/?1=2&1=3&3=4', POST='5=6&7=8')
    ...
    def test_getitem_with_square_brackets(self):
        req = webapp3.Request.blank('/endpoint?x[1]=3&a=1&a=2&b=0')
    ...
    def test_arguments(self):
        req = webapp3.Request.blank('/?1=2&3=4', POST='5=6&7=8')
    ...
    def test_get_with_FieldStorage(self):
        ...
        import cgi
        req = webapp3.Request.from_string(_test_req)
        self.assertTrue(isinstance(req, webapp3.Request))
