# Copyright 2016 webapp3 AUTHORS All rights reserved.
#
...
def pytest_configure():
    ...
    # Prune the SDK's webapp3 path from sys.path to prevent loading the SDK's
    # bundled webapp3.
    import dev_appserver
    gae_path = os.path.dirname(dev_appserver.__file__)
    gae_webapp3_path = os.path.join(gae_path, 'lib', 'webapp3')

    sys.path = [path for path in sys.path if gae_webapp3_path not in path]
