...
Extra attributes
----------------
The parameters from the matched :class:`webapp3.Route` are set as attributes
...
function :func:`webapp3.get_request`.
...
that are shared during a request: it is the :attr:`webapp3.Request.registry`
attribute.
