...
class TestOne(unittest.TestCase, CherryPickingMixin):
    ...
    def test_unit_cherry_pick(self):
    ...
    def test_unit_cherry_pick_empty_additional_attrs(self):
    ...
    def test_unit_cherry_pick_attr_map_error_wrong_type(self):
        namespace = self.namespace.copy()
        namespace['__attr_map__'] = list(namespace['__attr_map__'])
        self.assertRaises(ImportError, cherry_pick, namespace)

    def test_unit_cherry_pick_attr_map_error_empty_tuple(self):
        namespace = self.namespace.copy()
        namespace['__attr_map__'] = tuple()
        self.assertRaises(ImportError, cherry_pick, namespace)

    def test_unit_cherry_pick_attr_map_error_not_defined(self):
        namespace = self.namespace.copy()
        del namespace['__attr_map__']
        self.assertRaises(ImportError, cherry_pick, namespace)

    def test_unit_cherry_pick_additional_attr_error(self):
        namespace = self.namespace.copy()
...
class TestTwo(unittest.TestCase, CherryPickingMixin):
    ...
    def test_unit_cherry_pick_import_module(self):
        cherry_pick(self.namespace)
        kwargs = dict()
        kwargs['__loader__'] = sentinel.loader
        kwargs['__path__'] = self.namespace['__path__']
...
class TestThree(unittest.TestCase, CherryPickingMixin):
    ...
    def test_unit_cherry_pick_find_spec_raises(self):
...
class TestFour(unittest.TestCase, CherryPickingMixin):
    ...
    def test_unit_cherry_pick_additional_attrs_key_raises(self):
        with self.assertRaises(ImportError):
            cherry_pick(self.namespace)
