...
class TestTwo(unittest.TestCase):
    ...
    def test_unit_lazy_import_module_allready_loaded(self):
        mod = lazy_import_module('foo')
...
class TestThree(unittest.TestCase):
    ...
    def test_unit_lazy_import_module_no_spec(self):
