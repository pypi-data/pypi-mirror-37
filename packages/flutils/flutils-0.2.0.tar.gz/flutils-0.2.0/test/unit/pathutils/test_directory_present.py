...
class TestDirectoryPresent(unittest.TestCase):
    ...
    def test_unit_directory_present_with_parents_default(self):
    ...
    def test_unit_directory_present_with_parents_mode_user_group(self):
        mode = 0o770
        user = 'test_user'
        group = 'test_group'
        directory_present(
...
class TestDirectoryPresentExisting(unittest.TestCase):
    ...
    def test_unit_directory_present_exists(self):
        directory_present(self.path.as_posix())
        self.normalize_path.assert_called_with(self.path.as_posix())
...
class TestDirectoryPresentGlobError(unittest.TestCase):
    ...
    def test_unit_directory_present_glob_error(self):
...
class TestDirectoryPresentAbsoluteError(unittest.TestCase):
    ...
    def test_unit_directory_present_absolute_error(self):
        self.assertRaises(ValueError, directory_present, self.path.as_posix())
        self.normalize_path.assert_called_with(self.path.as_posix())
        self.path.mkdir.assert_not_called()
        self.chmod.assert_not_called()
...
class TestDirectoryPresentFileError(unittest.TestCase):
    ...
    def test_unit_directory_present_file_error(self):
        self.assertRaises(
            FileExistsError,
            directory_present,
            self.path.as_posix()
...
class TestDirectoryPresentBlockDeviceError(unittest.TestCase):
    ...
    def test_unit_directory_present_block_device_error(self):
        self.assertRaises(
            FileExistsError,
            directory_present,
            self.path.as_posix()
...
class TestDirectoryPresentCharDeviceError(unittest.TestCase):
    ...
    def test_unit_directory_present_char_device_error(self):
        self.assertRaises(
            FileExistsError,
            directory_present,
            self.path.as_posix()
...
class TestDirectoryPresentFifoError(unittest.TestCase):
    ...
    def test_unit_directory_present_fifo_error(self):
        self.assertRaises(
            FileExistsError,
            directory_present,
            self.path.as_posix()
...
class TestDirectoryPresentSocketError(unittest.TestCase):
    ...
    def test_unit_directory_present_socket_error(self):
        self.assertRaises(
            FileExistsError,
            directory_present,
            self.path.as_posix()
...
class TestDirectoryPresentParentFileError(unittest.TestCase):
    ...
    def test_unit_directory_present_parent_file_error(self):
        self.assertRaises(
            FileExistsError,
            directory_present,
            self.path.as_posix()
...
class TestDirectoryPresentParentBlockDeviceError(unittest.TestCase):
    ...
    def test_unit_directory_present_parent_block_device_error(self):
        self.assertRaises(
            FileExistsError,
            directory_present,
            self.path.as_posix()
...
class TestDirectoryPresentParentCharDeviceError(unittest.TestCase):
    ...
    def test_unit_directory_present_parent_char_device_error(self):
        self.assertRaises(
            FileExistsError,
            directory_present,
            self.path.as_posix()
...
class TestDirectoryPresentParentFifoError(unittest.TestCase):
    ...
    def test_unit_directory_present_parent_fifo_error(self):
        self.assertRaises(
            FileExistsError,
            directory_present,
            self.path.as_posix()
...
class TestDirectoryPresentParentSocketError(unittest.TestCase):
    ...
    def test_unit_directory_present_parent_socket_error(self):
        self.assertRaises(
            FileExistsError,
            directory_present,
            self.path.as_posix()
