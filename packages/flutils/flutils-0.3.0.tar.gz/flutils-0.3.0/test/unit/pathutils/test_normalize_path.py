...
class TestNormalizePath(unittest.TestCase):
    ...
    def test_unit_normalize_path(self):
    ...
    def test_unit_normalize_path_bytes(self):
        path = normalize_path(
            '~/tmp/foo/../$TEST'.encode(sys.getfilesystemencoding())
        )
        self.assertEqual(path.as_posix(), '/home/test_user/tmp/test')

    def test_unit_normalize_path_posix_path(self):
...
class TestNormalizePathCwd(unittest.TestCase):
    ...
    def test_unit_normalize_path_cwd(self):
