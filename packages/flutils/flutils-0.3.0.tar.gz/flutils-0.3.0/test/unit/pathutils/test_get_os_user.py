...
class TestGetOsUser(unittest.TestCase):
    ...
    def test_unit_get_os_user_name_is_none(self):
    ...
    def test_unit_get_os_user_name_is_given(self):
    ...
    def test_unit_get_os_user_uid(self):
...
class TestGetOsUserException(unittest.TestCase):
    ...
    def test_unit_get_os_user_name_is_invalid(self):
        self.assertRaises(OSError, get_os_user, 'test_user')
        self.getpwuid.assert_not_called()
        self.getuser.assert_not_called()

    def test_unit_get_os_user_uid_is_invalid(self):
