...
class AkeylessApiI(object):
    ...
    def derive_key(self, derivation_creds, kfm_user_creds, derivations_data, double_derivation=False):
        ...
        :return: (bytes, list): The derived key and a list of the final derivations data (in case of double
                                derivation the final derivations data list will be different from the origin
                                derivations data list).
        """
    ...
    def create_aes_key_item(self, akeyless_uam_user_creds, item_name, alg, user_metadata, split_level, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.create_item(akeyless_uam_user_creds, item_name, alg, user_metadata, split_level, async=True)
        >>> result = thread.get()
