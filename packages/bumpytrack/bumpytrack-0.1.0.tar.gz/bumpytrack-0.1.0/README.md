...
Say you're using [`git-flow`](https://github.com/nvie/gitflow) and you've just merged a feature to your development branch. You can just checkout and pull it, and then do:
