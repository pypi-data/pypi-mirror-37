...
class NFSGetExportCommand(qumulo.lib.opts.Subcommand):
    ...
    @staticmethod
    def main(conninfo, credentials, args):
        print nfs.nfs_get_export(conninfo, credentials, args.id)
...
class NFSModExportCommand(qumulo.lib.opts.Subcommand):
    ...
    @staticmethod
    def main(conninfo, credentials, args):
        response = nfs.nfs_get_export(conninfo, credentials, args.id)
        ...
        del export_info['id']
        if args.export_path is not None:
            export_info['export_path'] = args.export_path
        if args.fs_path is not None:
...
class NFSDeleteExportCommand(qumulo.lib.opts.Subcommand):
    ...
    @staticmethod
    def main(conninfo, credentials, args):
        nfs.nfs_delete_export(conninfo, credentials, args.id)
