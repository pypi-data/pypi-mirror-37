...
def _gcd_import(name, package=None, level=0, py26_local_import_attempt=False):
                ...
                try:
                    ...
                    try:
                        ...
                        try:
                            ...
                            _sibling_module_name = '.'.join([_outer_module_name.rsplit('.', 1)[0], name])
                            if _sibling_module_name in sys.modules.keys():
                                return sys.modules[_sibling_module_name]
                            ...
                            pass
                            #print('devconfig importlib2 python27 patch error', pass_e)
                        raise e
            else:
                module = _gcd_import(name)
        else:
