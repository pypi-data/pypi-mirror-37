...
//            }
        ...
        $scope.register = function(){
          ...
          if(!$scope.age || !$scope.height || !$scope.weight){
              $scope.errorMessage = "age, height, weight are required ";
          }
          if($scope.password){
          ...
          if($scope.contactNumber){
              if($scope.contactNumber.length != 13){
                $scope.errorMessage = "Number length is wrong (length of +380961231212 is 13) ";
              }
          } else {
...
//          should send to api backend
            ...
            WebappService.registerNewUser($scope.contactNumber, $scope.hashed_password,
             $scope.name, $scope.age, $scope,height, $scope.weight,
