...
project = u'FASTR'
copyright = u'2011 -- 2017, Biomedical Imaging Group Rotterdam, Departments of ' \
            u'Medical Informatics and Radiology, Erasmus MC, Rotterdam, The Netherlands'
...
latex_documents = [
    ('index', 'FASTR.tex', u'FASTR Documentation',
     u'Fastr contributors', 'manual'),
]
...
man_pages = [
    ('index', 'bigr-fastr', u'FASTR Documentation',
     [u'Fastr contributors'], 1)
]
