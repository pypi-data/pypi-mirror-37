        ...
        if isinstance(item, SampleId):
            ...
            if not item.isslice:
                try:
                    ...
                    fastr.log.info('DIMENSIONS: {}'.format(self.dimensions))
                    fastr.log.info('INDEX LOOKUP: {}'.format(self._index_lookup))
                    fastr.log.info('ID LOOKUP: {}'.format(self._id_lookup))
                    fastr.log.info('PARENT: {}'.format(self.parent))
                    fastr.log.info('PARENT FULLID: {}'.format(self.parent.fullid))
