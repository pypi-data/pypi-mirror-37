...
geometry = structures.prism(step, NSIDE=int(120/step), H=12/step, mesh='cube')
geometry = structures.center_struct(geometry)

material = materials.gold()
n1, n2 = 1.45, 1.33          # water on glass

struct = structures.struct(step, geometry, material, n1,n2, structures.get_normalization('cube'),
...
## heat distribution in struct at plasmon resonance (around 820nm for the coarse mesh)
idx_struct = tools.get_closest_field_index(sim, dict(wavelength=820))
print "structure-plot wavelength:", wl[idx_struct]
