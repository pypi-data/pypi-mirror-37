...
class StorageService:
    ...
    def get_object(
        ...
        return bucket.get_object(object_name, requester_pay and self.requester_pay)
    ...
    def get_data(
        ...
        bucket: Bucket = self.get_bucket(bucket_name)
        return bucket.get_object_data(object_name, requester_pay and self.requester_pay)
    ...
    def get_data_as_text(
        ...
        raw_data: bytes = self.get_data(
            bucket_name,
            object_name,
            requester_pay and self.requester_pay
        )
        if raw_data:
