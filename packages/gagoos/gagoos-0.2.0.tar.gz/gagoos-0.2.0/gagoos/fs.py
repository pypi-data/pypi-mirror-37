...
class FileSystemObject(Object):
    ...
    def _download_to_file(self, local_file_path: str, request_pay: bool = False):
...
class FileSystemBucket(Bucket):
    ...
    def get_object_list(self, prefix: str=None, request_pay=False) -> list:
        file_list = list()
        for root, dirs, files in os.walk(os.path.join(self.directory, prefix)):
            for file_name in files:
                file_list.append(os.path.join(root, file_name))
        return file_list

    def get_object(self, object_name: str, request_pay=False) -> Object or None:
    ...
    def get_object_data(self, object_name: str, request_pay=False) -> bytes or None:
        if self.exist(object_name):
            full_path = os.path.join(self.directory, object_name)
