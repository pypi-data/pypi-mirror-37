...
def cap_set_buffer(dev, max_frcnt_in_buffer):
    return _dmcam.cap_set_buffer(dev, max_frcnt_in_buffer)
cap_set_buffer = _dmcam.cap_set_buffer
...
def frame_get_dist_u16(dev, dst, dst_len, src, finfo):
    return _dmcam.frame_get_dist_u16(dev, dst, dst_len, src, finfo)
...
def frame_get_gray_u16(dev, dst, dst_len, src, finfo):
    return _dmcam.frame_get_gray_u16(dev, dst, dst_len, src, finfo)
