...
_dmcam.DEV_REG_MCU_swigconstant(_dmcam)
...
_dmcam.DM_FRAME_FMT_RAW_swigconstant(_dmcam)
...
_dmcam.DMCAM_FILTER_ID_GAUSS_swigconstant(_dmcam)
...
_dmcam.DMCAM_FRAME_SAVE_PCL_swigconstant(_dmcam)
