...
class JemuI2cSlave(object):
    ...
    def on_master_read(self, callback):
        ...
        :param callback: A callback function that will be called with the following arguments (device_address, read_index). The callback must return a tuple: (ack, response).
        """
        with self._lock:
