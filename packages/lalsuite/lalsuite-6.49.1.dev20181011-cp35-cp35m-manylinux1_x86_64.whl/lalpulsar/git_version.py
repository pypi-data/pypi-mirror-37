...
id = "ef6a291e859f5167eef5840d072f2a406065393f"
date = "2018-10-11 01:15:31 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "ef6a291e859f5167eef5840d072f2a406065393f":
        return
    msg = "Program id (ef6a291e859f5167eef5840d072f2a406065393f) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
