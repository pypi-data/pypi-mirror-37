...
id = "b0c14a53ce97a4c729c7e3289614b8cd200a40d8"
date = "2018-10-9 04:20:26 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "b0c14a53ce97a4c729c7e3289614b8cd200a40d8":
        return
    msg = "Program id (b0c14a53ce97a4c729c7e3289614b8cd200a40d8) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
