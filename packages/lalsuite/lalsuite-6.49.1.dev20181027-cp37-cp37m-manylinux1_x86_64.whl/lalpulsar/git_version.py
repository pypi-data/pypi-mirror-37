...
id = "85bd8a236e21e3e0b1223fabf554b655f1ce62c1"
date = "2018-10-26 11:49:34 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "85bd8a236e21e3e0b1223fabf554b655f1ce62c1":
        return
    msg = "Program id (85bd8a236e21e3e0b1223fabf554b655f1ce62c1) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
