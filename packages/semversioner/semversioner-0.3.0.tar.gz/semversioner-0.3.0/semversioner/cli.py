#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Convert next release changes to version releases. At any given time, the ``.changes/`` directory looks like:
    .changes
    |
    └── next-release
        ├── bugfix-BP-2012.json
...
def release(changedir):
    ...
    print("Regenerating 'next.version' file...")
    with open('next.version', 'w') as f:
        f.write(next_version_number)

    # generate CHANGELOG.md
    print("Regenerating 'CHANGELOG.md' file...")
