...
def add(ctx, file, title):
    ...
    logger.info("Successfully added SSH key: {}:{}".format(key.title, key.fingerprint))
...
def remove(ctx, title):
    ...
    logger.info("Successfully removed SSH public key: title={}, fingerprint={}".format(key.title, key.fingerprint))
