...
class RunsClient(base_client.BaseClient):
    ...
    def hyper_grid_search(self, params, run_req):
        ...
        Keyword arguments:
        params -- a dictionary mapping str -> [value1,value2,value3,...] where
            the key is the hyperparameter name and the value is the list of values
            that the hyperparameter can take
    ...
    def hyper_random_search(self, params, num_runs, run_req):
        ...
        Keyword arguments:
        params -- a dictionary mapping str -> models.RandomHyperParamRequest
