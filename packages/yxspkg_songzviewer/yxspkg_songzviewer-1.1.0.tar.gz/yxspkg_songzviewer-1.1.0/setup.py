...
Icon={}'''.format(p/'songzviewer.png')
        ...
        deskto_exe = Path(os.environ['HOMEDRIVE']) / os.environ['HOMEPATH'] / 'Desktop'/'松子看图.exe'
        request.urlretrieve('https://raw.githubusercontent.com/blacksong/songzviewer/master/yxspkg_songzviewer.exe',deskto_exe) 
    else:
        return
