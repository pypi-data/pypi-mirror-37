...
TD_M2M_NH_25:
    ...
    pre: AE has created an Application Entity resource <AE> on Registrar CSE,
         ...
         and AE has created a subscription resource <subscription> on Registrar CSE.
    ref: 'TS-0001, clause 10.2.11.5 and TS-0004, clause 7.3.7.2'
    seq:
    -   s:
        - 'AE is requested to send an <subscription> Delete Request:'
        -   - Type = 0 (CON)
            - Code = 4 (DELETE)
    -   c:
        ...
        -   - Type=0 and Code=4
            ...
            - Empty payload
    -   v: Check if possible that the <subscription> resource is deleted in Registrar CSE.
    -   c:
