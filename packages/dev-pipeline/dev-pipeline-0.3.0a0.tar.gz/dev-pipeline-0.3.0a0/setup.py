...
setup(
    ...
    install_requires=[
        ...
        'dev-pipeline-bootstrap >= 0.3.0a0',
        'dev-pipeline-build >= 0.3.0a0',
        'dev-pipeline-build-order >= 0.3.0a0',
        'dev-pipeline-configure >= 0.3.0a0',
        'dev-pipeline-scm >= 0.3.0a0',

        # extra builders included by default
        'dev-pipeline-cmake >= 0.3.0a0',

        # extra scms included by default
        'dev-pipeline-git >= 0.3.0a0'
    ],
