...
def postprocessxxxxxxx(testenv_config, value):
    print("testenv_config: ")
    print(testenv_config)
    print("value: ")
    print(value)
    x = 1
...
def tox_addoption(parser):
    print(parser)
    parser.add_testenv_attribute(name="foobar", type="string", help="maaaaoiiii", default="Parametro Foobar", postprocess=postprocessxxxxxxx)
