...
def datetime_partition_server_data_feature_settings(datetime_partition_server_data):
    ...
    settings.update({
        'featureSettings': [
            {'featureName': 'timestamp', 'aPriori': True},
            {'featureName': 'target', 'aPriori': True},
            {'featureName': 'series_id', 'aPriori': False},
            {'featureName': 'input3', 'aPriori': False},
            {'featureName': 'input4', 'aPriori': True}
        ],
    })
    return settings
...
def datetime_partition_time_series_server_data(datetime_partition_server_data):
    settings = dict(datetime_partition_server_data)
    time_series_settings = {'useTimeSeries': True, 'defaultToAPriori': True,
...
def datetime_partition_after_target_server_data_feature_settings(
    ...
    settings.update({
        'featureSettings': [
            {'featureName': 'timestamp', 'aPriori': True},
            {'featureName': 'target', 'aPriori': True},
            {'featureName': 'series_id', 'aPriori': True},
            {'featureName': 'input3', 'aPriori': True},
            {'featureName': 'input4', 'aPriori': True}
        ],
    })
    return settings
...
def datetime_partition_spec_feature_settings(
    ...
    return DatetimePartitioningSpecification(
        ...
        feature_settings=[FeatureSettings(fs['featureName'], fs['aPriori'])
...
def time_series_partition_spec(datetime_partition_time_series_server_data, holdout_start_date):
    ...
    return DatetimePartitioningSpecification(
        ...
        default_to_a_priori=datetime_partition_time_series_server_data['defaultToAPriori'],
