...
{'': ['*'],
 'cvbuilder': ['config/*'],
 'cvbuilder.__syspatch__.vendor': ['click/*', 'click_log/*']}

install_requires = \
['numpy>=1.15,<2.0', 'pip>=9.0.1', 'requests>=2.19,<3.0']
...
setup_kwargs = {
    'name': 'cvbuilder',
    'version': '0.2.18',
    'description': 'Package for building OpenCV 4.0.0-alpha including Python 3 bindings from the official sources.',
