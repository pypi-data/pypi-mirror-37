...
import xlrd
import struct
from .common import FieldType,FieldInfo,getTypeByName,getCellName,getFieldSize,getFuncName,saveUtf8File,ensureDirExist
            ...
            for k in range(n):
                ...
                if fieldType == FieldType.Byte:
                    ...
                    if isEmpty:
                        ...
                        f2.write(u8)
                        f1.write(struct.pack('B', 0)) # C++字符串的\0标记
