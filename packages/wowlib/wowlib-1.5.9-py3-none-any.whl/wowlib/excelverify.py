            ...
            if check_head: # 头部区域
                ...
                if col0_str.find('###') == 0:
                    ...
                    for col in range(ncols):
                        ...
                        strType = sheet.cell_value(row, col)
                        fType = getTypeByName(strType)
                        ...
                        if fType != None and fName != '': # 有效的列，必须类型有效且名字不为空
                            ...
                            if fType == None and strType != '':
                                return 0, "[" + strCellName + "] Type `" + strType + "` not implement"
                            if fType != None and fName == '':
                                return 0, "[" + chr(65 + col) + str(row) + "] Missing field name"
