...
import os
import xlrd
from .common import FieldType,FieldInfo,getTypeByName,getCellName,getFieldSize,getFuncName,getTypeNameForCs,saveUtf8File,ensureDirExist
...
def ExcelToTs(srcFile, dstFile, csType, hasGT, strSeparator):
    ...
    try:    
        ...
        if fieldList[0].type == FieldType.Index or fieldList[0].type == FieldType.Key or fieldList[0].type == FieldType.Map:
            hasIndexCol = True
        totalText += "export default class Cfg" + tableName + " {data={\n"
