...
if "aldebaran" in platform.platform():
    ...
    os.environ["QI_ADDITIONAL_SDK_PREFIXES"] = path_robot_lib
    ...
    os.environ["QI_ADDITIONAL_SDK_PREFIXES"] = path_linux_lib
    ...
    os.environ["QI_ADDITIONAL_SDK_PREFIXES"] = path_mac_lib
    ...
    path_win_lib = os.path.join(PATH_LIBQI, "win")
    os.environ["QI_ADDITIONAL_SDK_PREFIXES"] = path_win_lib
    sys.path.append(path_win_lib)
