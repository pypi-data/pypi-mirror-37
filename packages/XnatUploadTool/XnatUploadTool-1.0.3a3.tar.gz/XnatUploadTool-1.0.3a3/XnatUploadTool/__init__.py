        ...
        for mysubject, mysubjectdata in self.ingestdata.items():
            ...
            for mysession, mysessiondata in mysubjectdata['sessions'].items():
                ...
                for myscan, myscandata in mysessiondata['scans'].items():
                        # If threads set to 1 don't use mp pool
                        # results.append(self.process_ingested_scan(subject=mysubject,
                        #                                           session=mysession,
                        #                                           scan=myscan,
                        #                                           datatype=mysessiondata['datatype'],
                        #                                           xmlnamespace=mysessiondata['xmlnamespace'],
