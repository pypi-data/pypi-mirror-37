...
from mountcontrol.test import configTest
...
class TestConfigData(unittest.TestCase):
    ...
    def test_ObsSite_expire_ok(self):
        pathToTS = '~/PycharmProjects/mountcontrol/data'
        obsSite = ObsSite(pathToTS=pathToTS)
        obsSite.expire = True
    ...
    def test_Site_timeJD(self):
        ...
        self.assertEqual(2458240.12345678, obsSite.timeJD.tt)
        obsSite.timeJD = 2458240.12345678
        self.assertEqual(2458240.12345678, obsSite.timeJD.tt)
        obsSite.timeJD = '2458240.a23e5678'
        self.assertEqual(None, obsSite.timeJD)
    ...
    def test_Site_ra(self):
        ...
        obsSite.raJNow = skyfield.api.Angle(degrees=34)
        self.assertEqual(34, obsSite.raJNow.degrees)
        obsSite.raJNow = 34
        self.assertEqual(34, obsSite.raJNow.degrees)
        self.assertEqual(34, obsSite._raJNow.degrees)
        obsSite.raJNow = '34'
        self.assertEqual(34, obsSite.raJNow.degrees)
        obsSite.raJNow = '34f'
    ...
    def test_ObsSite_parseFast_ok(self):
        obsSite = ObsSite()

        response = ['13:15:35.68',
                    '19.44591,+88.0032,W,002.9803,+47.9945,2458352.10403639,5,0']
        suc = obsSite._parsePointing(response, 2)
        self.assertEqual(True, suc)

    def test_ObsSite_pollFast_ok(self):
        obsSite = ObsSite()
    ...
    def test_ObsSite_setLatitude_ok1(self):
        ...
        with mock.patch('mountcontrol.obsSite.Connection') as mConn:
            mConn.return_value.communicate.return_value = True, response, 1
            suc = obsSite.setLatitude('50 50 50')
            self.assertEqual(True, suc)
    ...
    def test_ObsSite_setLongitude_ok1(self):
        ...
        with mock.patch('mountcontrol.obsSite.Connection') as mConn:
            mConn.return_value.communicate.return_value = True, response, 1
            suc = obsSite.setLongitude('50 50 50')
            self.assertEqual(True, suc)
