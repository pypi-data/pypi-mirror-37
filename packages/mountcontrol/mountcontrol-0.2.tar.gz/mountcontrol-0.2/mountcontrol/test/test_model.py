...
class TestConfigData(unittest.TestCase):
    ...
    def test_Model_programAlign_ok3(self):
        ...
        with mock.patch('mountcontrol.model.Connection') as mConn:
            ...
            suc = model.programAlign(build)
            self.assertEqual(False, suc)
            mConn.return_value.communicate.assert_called_with(':newalig#:newalpt19:35:15.6,-15*02:043,W,19:35:45.3,-15*03:042,17:35:31.75#:endalig#')
    ...
    def gatherData(number):
        import json
        import os
        with open('2018-07-08-21-41-44_full.dat', 'r') as infile:
