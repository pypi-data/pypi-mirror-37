...
class latin_square():
	...
	def print(self):
		...
		x.add_row(["Rows", self.ss_rows, self.df_rows, self.ms_rows, self.F_rows, self.p_value_rows])
		x.add_row(["Columns", self.ss_columns, self.df_columns, self.ms_columns, self.F_columns, self.p_value_columns])
