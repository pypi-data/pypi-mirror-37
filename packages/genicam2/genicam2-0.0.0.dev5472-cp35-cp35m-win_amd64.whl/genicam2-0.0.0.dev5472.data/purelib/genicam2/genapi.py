...
class ios_base(_object):
    ...
    __swig_getmethods__["sync_with_stdio"] = lambda x: _genapi.ios_base_sync_with_stdio
    if _newclass:
    ...
    __swig_getmethods__["xalloc"] = lambda x: _genapi.ios_base_xalloc
    if _newclass:
...
class ESignClass(_object):
    ...
    __repr__ = _swig_repr
    __swig_getmethods__["from_string"] = lambda x: _genapi.ESignClass_from_string
    if _newclass:
        from_string = staticmethod(_genapi.ESignClass_from_string)
    __swig_getmethods__["to_string"] = lambda x: _genapi.ESignClass_to_string
    if _newclass:
...
class EEndianessClass(_object):
    ...
    __repr__ = _swig_repr
    __swig_getmethods__["from_string"] = lambda x: _genapi.EEndianessClass_from_string
    if _newclass:
        from_string = staticmethod(_genapi.EEndianessClass_from_string)
    __swig_getmethods__["to_string"] = lambda x: _genapi.EEndianessClass_to_string
    if _newclass:
...
class ERepresentationClass(_object):
    ...
    __repr__ = _swig_repr
    __swig_getmethods__["from_string"] = lambda x: _genapi.ERepresentationClass_from_string
    if _newclass:
        from_string = staticmethod(_genapi.ERepresentationClass_from_string)
    __swig_getmethods__["to_string"] = lambda x: _genapi.ERepresentationClass_to_string
    if _newclass:
...
class EVisibilityClass(_object):
    ...
    __repr__ = _swig_repr
    __swig_getmethods__["from_string"] = lambda x: _genapi.EVisibilityClass_from_string
    if _newclass:
        from_string = staticmethod(_genapi.EVisibilityClass_from_string)
    __swig_getmethods__["to_string"] = lambda x: _genapi.EVisibilityClass_to_string
    if _newclass:
...
class EAccessModeClass(_object):
    ...
    __repr__ = _swig_repr
    __swig_getmethods__["from_string"] = lambda x: _genapi.EAccessModeClass_from_string
    if _newclass:
        from_string = staticmethod(_genapi.EAccessModeClass_from_string)
    __swig_getmethods__["to_string"] = lambda x: _genapi.EAccessModeClass_to_string
    if _newclass:
...
class ECachingModeClass(_object):
    ...
    __repr__ = _swig_repr
    __swig_getmethods__["from_string"] = lambda x: _genapi.ECachingModeClass_from_string
    if _newclass:
        from_string = staticmethod(_genapi.ECachingModeClass_from_string)
    __swig_getmethods__["to_string"] = lambda x: _genapi.ECachingModeClass_to_string
    if _newclass:
...
class ENameSpaceClass(_object):
    ...
    __repr__ = _swig_repr
    __swig_getmethods__["from_string"] = lambda x: _genapi.ENameSpaceClass_from_string
    if _newclass:
        from_string = staticmethod(_genapi.ENameSpaceClass_from_string)
    __swig_getmethods__["to_string"] = lambda x: _genapi.ENameSpaceClass_to_string
    if _newclass:
...
class EYesNoClass(_object):
    ...
    __repr__ = _swig_repr
    __swig_getmethods__["from_string"] = lambda x: _genapi.EYesNoClass_from_string
    if _newclass:
        from_string = staticmethod(_genapi.EYesNoClass_from_string)
    __swig_getmethods__["to_string"] = lambda x: _genapi.EYesNoClass_to_string
    if _newclass:
...
class EStandardNameSpaceClass(_object):
    ...
    __repr__ = _swig_repr
    __swig_getmethods__["from_string"] = lambda x: _genapi.EStandardNameSpaceClass_from_string
    if _newclass:
        from_string = staticmethod(_genapi.EStandardNameSpaceClass_from_string)
    __swig_getmethods__["to_string"] = lambda x: _genapi.EStandardNameSpaceClass_to_string
    if _newclass:
...
class ESlopeClass(_object):
    ...
    __repr__ = _swig_repr
    __swig_getmethods__["from_string"] = lambda x: _genapi.ESlopeClass_from_string
    if _newclass:
        from_string = staticmethod(_genapi.ESlopeClass_from_string)
    __swig_getmethods__["to_string"] = lambda x: _genapi.ESlopeClass_to_string
    if _newclass:
...
class EDisplayNotationClass(_object):
    ...
    __repr__ = _swig_repr
    __swig_getmethods__["from_string"] = lambda x: _genapi.EDisplayNotationClass_from_string
    if _newclass:
        from_string = staticmethod(_genapi.EDisplayNotationClass_from_string)
    __swig_getmethods__["to_string"] = lambda x: _genapi.EDisplayNotationClass_to_string
    if _newclass:
...
class EInputDirectionClass(_object):
    ...
    __repr__ = _swig_repr
    __swig_getmethods__["from_string"] = lambda x: _genapi.EInputDirectionClass_from_string
    if _newclass:
        from_string = staticmethod(_genapi.EInputDirectionClass_from_string)
    __swig_getmethods__["to_string"] = lambda x: _genapi.EInputDirectionClass_to_string
    if _newclass:
...
class INodeMap(_object):
    ...
    def __dir__(self):
        ...
        try:
            l += [x.get_node().get_name() for x in filter(lambda n: n.get_node().is_feature(), self.get_nodes())]
        except:
            pass
        try:
            l += [x.get_node() for x in filter(lambda n: "ChunkData" in (f.Name for f in n.get_parents()), self.get_nodes())]
        except:
            pass
        return sorted(set(l))
...
_genapi.CHUNK_BASE_ADDRESS_REGISTER_LEN_swigconstant(_genapi)
CHUNK_BASE_ADDRESS_REGISTER_LEN = _genapi.CHUNK_BASE_ADDRESS_REGISTER_LEN

_genapi.CHUNK_LENGTH_REGISTER_LEN_swigconstant(_genapi)
...
class NodeMap(_object):
    ...
    __swig_getmethods__["clear_xml_cache"] = lambda x: _genapi.NodeMap_clear_xml_cache
    if _newclass:
        clear_xml_cache = staticmethod(_genapi.NodeMap_clear_xml_cache)

    def get_nodes(self):
        return _genapi.NodeMap_get_nodes(self)
    ...
    def __dir__(self):
        ...
        l += [x for x in self.__dict__.keys()]
        try:
            l += [x.node.name for x in filter(lambda n: n.node.is_feature(), self.get_nodes())]
        except:
            pass
        return sorted(set(l))
...
class ChunkPort(IPortConstruct):
    ...
    for _s in [IPortConstruct]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ChunkPort, name, value)
    __swig_getmethods__ = {}
    for _s in [IPortConstruct]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, ChunkPort, name)
    __repr__ = _swig_repr

    def __init__(self, pPort=None):
        this = _genapi.new_ChunkPort(pPort)
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _genapi.delete_ChunkPort
    __del__ = lambda self: None

    def _get_access_mode(self):
        return _genapi.ChunkPort__get_access_mode(self)

    def _get_principal_interface_type(self):
        return _genapi.ChunkPort__get_principal_interface_type(self)

    def read(self, pBuffer, Address, Length):
        return _genapi.ChunkPort_read(self, pBuffer, Address, Length)

    def write(self, pBuffer, Address, Length):
        return _genapi.ChunkPort_write(self, pBuffer, Address, Length)

    def set_port_impl(self, pPort):
        return _genapi.ChunkPort_set_port_impl(self, pPort)

    def _get_swap_endianess(self):
        return _genapi.ChunkPort__get_swap_endianess(self)

    def invalidate_node(self):
        return _genapi.ChunkPort_invalidate_node(self)

    def attach_port(self, pPort):
        return _genapi.ChunkPort_attach_port(self, pPort)

    def detach_port(self):
        return _genapi.ChunkPort_detach_port(self)

    def attach_chunk(self, pBaseAddress, ChunkOffset, Length, Cache):
        return _genapi.ChunkPort_attach_chunk(self, pBaseAddress, ChunkOffset, Length, Cache)

    def detach_chunk(self):
        return _genapi.ChunkPort_detach_chunk(self)

    def _get_chunk_id_length(self):
        return _genapi.ChunkPort__get_chunk_id_length(self)

    def check_chunk_id(self, *args):
        return _genapi.ChunkPort_check_chunk_id(self, *args)

    def update_buffer(self, pBaseAddress):
        return _genapi.ChunkPort_update_buffer(self, pBaseAddress)

    def clear_cache(self):
        return _genapi.ChunkPort_clear_cache(self)
...
ChunkPort_swigregister = _genapi.ChunkPort_swigregister
...
class AttachStatistics_t(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["NumChunkPorts"] = _genapi.AttachStatistics_t_NumChunkPorts_set
    __swig_getmethods__["NumChunkPorts"] = _genapi.AttachStatistics_t_NumChunkPorts_get
    if _newclass:
        NumChunkPorts = _swig_property(_genapi.AttachStatistics_t_NumChunkPorts_get, _genapi.AttachStatistics_t_NumChunkPorts_set)
    __swig_setmethods__["NumChunks"] = _genapi.AttachStatistics_t_NumChunks_set
    __swig_getmethods__["NumChunks"] = _genapi.AttachStatistics_t_NumChunks_get
    if _newclass:
        NumChunks = _swig_property(_genapi.AttachStatistics_t_NumChunks_get, _genapi.AttachStatistics_t_NumChunks_set)
    __swig_setmethods__["NumAttachedChunks"] = _genapi.AttachStatistics_t_NumAttachedChunks_set
    __swig_getmethods__["NumAttachedChunks"] = _genapi.AttachStatistics_t_NumAttachedChunks_get
    if _newclass:
        NumAttachedChunks = _swig_property(_genapi.AttachStatistics_t_NumAttachedChunks_get, _genapi.AttachStatistics_t_NumAttachedChunks_set)

    def __init__(self):
        this = _genapi.new_AttachStatistics_t()
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _genapi.delete_AttachStatistics_t
    __del__ = lambda self: None
AttachStatistics_t_swigregister = _genapi.AttachStatistics_t_swigregister
AttachStatistics_t_swigregister(AttachStatistics_t)

class ChunkAdapter(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, ChunkAdapter, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, ChunkAdapter, name)

    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    __swig_destroy__ = _genapi.delete_ChunkAdapter
    __del__ = lambda self: None

    def attach_node_map(self, pNodeMap):
        return _genapi.ChunkAdapter_attach_node_map(self, pNodeMap)

    def detach_node_map(self):
        return _genapi.ChunkAdapter_detach_node_map(self)

    def check_buffer_layout(self, pBuffer):
        return _genapi.ChunkAdapter_check_buffer_layout(self, pBuffer)

    def attach_buffer(self, pBuffer, pAttachStatistics=None):
        return _genapi.ChunkAdapter_attach_buffer(self, pBuffer, pAttachStatistics)

    def detach_buffer(self):
        return _genapi.ChunkAdapter_detach_buffer(self)

    def update_buffer(self, pBaseAddress):
        return _genapi.ChunkAdapter_update_buffer(self, pBaseAddress)

    def clear_caches(self):
        return _genapi.ChunkAdapter_clear_caches(self)
ChunkAdapter_swigregister = _genapi.ChunkAdapter_swigregister
ChunkAdapter_swigregister(ChunkAdapter)

class ChunkAdapterGEV(ChunkAdapter):
    __swig_setmethods__ = {}
    for _s in [ChunkAdapter]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ChunkAdapterGEV, name, value)
    __swig_getmethods__ = {}
    for _s in [ChunkAdapter]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, ChunkAdapterGEV, name)
    __repr__ = _swig_repr

    def __init__(self, pNodeMap=None, MaxChunkCacheSize=-1):
        this = _genapi.new_ChunkAdapterGEV(pNodeMap, MaxChunkCacheSize)
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _genapi.delete_ChunkAdapterGEV
    __del__ = lambda self: None

    def check_buffer_layout(self, pBuffer):
        return _genapi.ChunkAdapterGEV_check_buffer_layout(self, pBuffer)

    def attach_buffer(self, pBuffer, pAttachStatistics=None):
        return _genapi.ChunkAdapterGEV_attach_buffer(self, pBuffer, pAttachStatistics)
ChunkAdapterGEV_swigregister = _genapi.ChunkAdapterGEV_swigregister
...
class ChunkAdapterU3V(ChunkAdapter):
    ...
    for _s in [ChunkAdapter]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ChunkAdapterU3V, name, value)
    __swig_getmethods__ = {}
    for _s in [ChunkAdapter]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, ChunkAdapterU3V, name)
    __repr__ = _swig_repr

    def __init__(self, pNodeMap=None, MaxChunkCacheSize=-1):
        this = _genapi.new_ChunkAdapterU3V(pNodeMap, MaxChunkCacheSize)
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _genapi.delete_ChunkAdapterU3V
    __del__ = lambda self: None

    def check_buffer_layout(self, pBuffer):
        return _genapi.ChunkAdapterU3V_check_buffer_layout(self, pBuffer)

    def attach_buffer(self, pBuffer, pAttachStatistics=None):
        return _genapi.ChunkAdapterU3V_attach_buffer(self, pBuffer, pAttachStatistics)
ChunkAdapterU3V_swigregister = _genapi.ChunkAdapterU3V_swigregister
...
class SingleChunkData_t(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["ChunkID"] = _genapi.SingleChunkData_t_ChunkID_set
    __swig_getmethods__["ChunkID"] = _genapi.SingleChunkData_t_ChunkID_get
    if _newclass:
        ChunkID = _swig_property(_genapi.SingleChunkData_t_ChunkID_get, _genapi.SingleChunkData_t_ChunkID_set)
    __swig_setmethods__["ChunkOffset"] = _genapi.SingleChunkData_t_ChunkOffset_set
    __swig_getmethods__["ChunkOffset"] = _genapi.SingleChunkData_t_ChunkOffset_get
    if _newclass:
        ChunkOffset = _swig_property(_genapi.SingleChunkData_t_ChunkOffset_get, _genapi.SingleChunkData_t_ChunkOffset_set)
    __swig_setmethods__["ChunkLength"] = _genapi.SingleChunkData_t_ChunkLength_set
    __swig_getmethods__["ChunkLength"] = _genapi.SingleChunkData_t_ChunkLength_get
    if _newclass:
        ChunkLength = _swig_property(_genapi.SingleChunkData_t_ChunkLength_get, _genapi.SingleChunkData_t_ChunkLength_set)

    def __init__(self):
        this = _genapi.new_SingleChunkData_t()
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _genapi.delete_SingleChunkData_t
    __del__ = lambda self: None
SingleChunkData_t_swigregister = _genapi.SingleChunkData_t_swigregister
...
class ChunkAdapterGeneric(ChunkAdapter):
    ...
    for _s in [ChunkAdapter]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ChunkAdapterGeneric, name, value)
    __swig_getmethods__ = {}
    for _s in [ChunkAdapter]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, ChunkAdapterGeneric, name)
    __repr__ = _swig_repr

    def __init__(self, pNodeMap=None, MaxChunkCacheSize=-1):
        this = _genapi.new_ChunkAdapterGeneric(pNodeMap, MaxChunkCacheSize)
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _genapi.delete_ChunkAdapterGeneric
    __del__ = lambda self: None

    def check_buffer_layout(self, pBuffer):
        return _genapi.ChunkAdapterGeneric_check_buffer_layout(self, pBuffer)

    def attach_buffer(self, *args):
        return _genapi.ChunkAdapterGeneric_attach_buffer(self, *args)
ChunkAdapterGeneric_swigregister = _genapi.ChunkAdapterGeneric_swigregister
