...
def recordclass(typename, field_names, rename=False, defaults=None, module=None):
...
def __new__(_cls, {1}):
    ...
    return _memoryslots_new(_cls, {1})
"""
    ...
    namespace = dict(_memoryslots_new=_memoryslots_new)
    ...
    #@classmethod
    def _make(_cls, iterable):
        ob = _memoryslots_new(_cls, *iterable)
...
#     }
    ...
    _result = type(typename, (memoryslots,), class_namespace)
