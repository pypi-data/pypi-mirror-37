...
from frozentype import frozendict
...
class FrozendictTest(unittest.TestCase):
    ...
    def test_constructor(self):
        ...
        self.assertIsNot(frozendict(), {})
        self.assertIsNot(frozendict(), frozendict())

    def test_bool(self):
        self.assertIs(not frozendict(), True)
        self.assertTrue(frozendict({1: 2}))
        self.assertIs(bool(frozendict()), False)
        self.assertIs(bool(frozendict({1: 2})), True)
...
#         self.assertEqual(baddict3.fromkeys({"a", "b", "c"}), res)
    ...
    def test_copy(self):
        ...
        self.assertEqual(d.copy(), frozendict({1:1, 2:2, 3:3}))
        self.assertEqual(d.copy(), {1:1, 2:2, 3:3})
        self.assertEqual(frozendict().copy(), frozendict())
        self.assertEqual(frozendict().copy(), {})
    ...
    def test_pickle(self):
        d1 = frozendict()
        pd1 = pickle.dumps(d1)
        d11 = pickle.loads(pd1)
        self.assertEqual(d11, d1)
        d2 = frozendict(a=1,b=2,c=3)
        pd2 = pickle.dumps(d2)
        d21 = pickle.loads(pd2)
        self.assertEqual(d21, d2)
