...
def main():
    ...
    run_serve(backend_port, frontend_grpc_port, frontend_http_port, grpc_service)


def run_serve(backend_port, frontend_grpc_port, frontend_http_port, grpc_service):
