...
class Device(object):
    ...
    @_sync_xport
    def path_set_loops_timeout(self, timeout: int):
        self._path_client.path_set_loops_timeout(timeout)

    @_sync_xport
    def path_get_loops_timeout(self) -> int:
    ...
    @_sync_xport
    def path_set_config(self, barrier_timeout: int, loops_timeout: int, loops_hold: int):
    ...
    def path_get_config(self) -> dict:
        ...
        return dict(barrier_timeout=barrier_timeout.value,
                    loops_timeout=loops_timeout.value,
