...
class InvalidXMLDeclaration(Exception):
    ...
    def __str__(self):
        return u"Invalid XML Declaration:%s" % str(self.reason)
...
class XMLElementNotFound(Exception):
    ...
    def __str__(self):
        return u"No matching XML element at :%s" % str(self.path)
...
class XMLTooManyElementsFound(Exception):
    ...
    def __str__(self):
        return u"Multiple elements returned for : {path}" % str(self.path)
...
class UndefinedNamespace(Exception):
    ...
    def __str__(self):
        return u"Undefined namespace %s" % str(self.namespace_and_tag)
...
class XML(object):
    ...
    def __init__(self,
        ...
        self.__scanner = (string
                          ...
                          StringScanner(str(string)))  # Convert to future str for Py2 compatibility
        self.tag = None
