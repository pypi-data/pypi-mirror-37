...
def run_trimmomatic_pe(r1, r2, r1_paired, r1_orphaned, r2_paired, r2_orphaned,
                       ...
                       crop=None, head_crop=None, min_len=None, avg_qual=None, to_phred33=False,
                       to_phred64=False):
    """
    Args:
    ...
    cmd = ("java -jar {jar} PE -threads {threads} -phred{phred} {log} "
           "{r1} {r2} {r1p} {r2p} {r1o} {r2o} {trimmer}").format(jar="", log=trimlog,
