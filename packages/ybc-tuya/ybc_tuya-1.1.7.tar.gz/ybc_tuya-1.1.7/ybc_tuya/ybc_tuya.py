...
register_shape(data_path+'bird1.gif')
...
class game:
    ...
    def eatBonus(self):
        ...
        if (len(self.bonusList) > 0 and self.snake.xcor() < self.bonusList[0][1]+30 and self.snake.xcor() > self.bonusList[0][1] - 25 and self.snake.ycor() < self.bonusList[0][2] + 30 and self.snake.ycor() > self.bonusList[0][2] - 25):
            self.snake.length += 1
