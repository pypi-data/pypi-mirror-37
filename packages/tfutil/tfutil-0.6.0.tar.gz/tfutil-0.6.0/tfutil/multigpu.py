...
class MGTFModel:
    ...
    def train(self, gntr, num_epochs, metric_opdefs, extra_summ_ops=None, listeners=None,
        ...
        if listeners:
            for l in listeners:
                l.begin(self.ckpt_dir, self.inputs, self.labels, self.is_training, self.logits, steps_per_epoch)
        ...
        with tf.Session(config=sess_config_proto) as sess:
            ...
            epoch = global_step_val // steps_per_epoch
