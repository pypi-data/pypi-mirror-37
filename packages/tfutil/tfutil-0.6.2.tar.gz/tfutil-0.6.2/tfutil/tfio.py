...
def read_tfrec(filenames, batch_size=None, num_epochs=-1, shuffle=True, is_test=False):
...
@input_func_dec
def read_tfrec_func(filenames, batch_size=None, num_epochs=-1, shuffle=True, is_test=False):
    return read_tfrec(filenames, batch_size, num_epochs, shuffle, is_test)
...
def read_tfrec_img_func(filenames, shape, batch_size=None, num_epochs=-1, shuffle=True,
                        shape_enlarge=True, normalization=True, is_test=False):
    return read_tfrec_img(filenames, shape, batch_size, num_epochs, shuffle, shape_enlarge, normalization, is_test)
...
def read_tfimgrec_func(filenames, shape, batch_size=None, num_epochs=-1, shuffle=True, shape_enlarge=True,
                       normalization=True, is_test=False):
    return read_tfimgrec(filenames, shape, batch_size, num_epochs, shuffle, shape_enlarge, normalization, is_test)


def read_tfrec_array(arrs, batch_size=None, num_epochs=-1, shuffle=True, is_test=False, is_reg=False):
...
@input_func_dec
def read_tfrec_array_func(arrs, batch_size=None, num_epochs=-1, shuffle=True, is_test=False, is_reg=False):
    return read_tfrec_array(arrs, batch_size, num_epochs, shuffle, is_test, is_reg)
