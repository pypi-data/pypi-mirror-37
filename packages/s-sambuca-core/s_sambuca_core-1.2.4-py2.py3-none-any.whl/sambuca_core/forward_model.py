...
from .precompute import precompute_vals
...
def forward_model(
        ...
        bb_ph_star=None,
        bb_nap_star=None,
        inv_cos_theta_w=None,
        inv_cos_theta_0=None):
    """Semi-analytical Lee/Sambuca forward model.
    ...
    r_substratum = sub1_frac * substrate1 + \
