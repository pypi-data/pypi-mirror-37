...
def model_pretrained (input_reshape,name_model ='vgg16',num_classes=2,optimizers_func='Adam', loss_func='binary_crossentropy'):
    ...
    if name_model == 'resnet50':
        ...
        print 'this pretrained model is not supported!!'
...
def call_model (type_model,m_input_shape, m_num_classes, m_optimizer,m_learning_rate, m_learning_decay,m_loss_func,
            ...
            svm_c, svm_kernel, rf_n_estimators):
