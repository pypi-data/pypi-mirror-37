# Generated by Django 2.1.2 on 2018-10-19 16:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_except', models.CharField(blank=True, default='[]', help_text='以json格式', max_length=255, null=True, verbose_name='不包含内容')),
                ('lazy_photo', models.CharField(blank=True, default='', help_text='延时图片替换src值的', max_length=128, null=True, verbose_name='图片属性')),
