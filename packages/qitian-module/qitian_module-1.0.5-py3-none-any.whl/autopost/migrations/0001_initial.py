    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desc', models.TextField(blank=True, null=True, verbose_name='摘要')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('check_duration', models.IntegerField(default=180, help_text='间隔分钟', verbose_name='检查间隔')),
                ('duplicate_check', models.IntegerField(choices=[(1, 'URL'), (2, '标题')], default=1, verbose_name='重复检测')),
                ...
                ('content_except', models.CharField(blank=True, help_text='以json格式', max_length=255, null=True, verbose_name='不包含内容')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(2, '主菜单'), (1, '显示'), (0, '隐藏')], default=1, verbose_name='状态')),
