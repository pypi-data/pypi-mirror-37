...
class AutoTask(models.Model):
    ...
    content_except = models.CharField('不包含内容', help_text='以json格式', max_length=255, blank=True, null=True, default='[]')
    lazy_photo = models.CharField('图片属性', help_text='延时图片替换src值的', max_length=128, blank=True, null=True, default='')
