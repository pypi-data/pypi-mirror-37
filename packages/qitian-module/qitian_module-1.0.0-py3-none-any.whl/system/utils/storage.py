...
class HtmlStorage:
    ...
    @staticmethod
    def save_content(content, save_img=True, remove_a=True, send_qiniu=False):
        """
        保存html中图片 并提取最一张图片
        :param content:
        :param remove_a:
        ...
        return html_content, first_img, ' '.join(tr_keyword.get_keyphrases(10, 1)), tr_sentence.get_key_sentences(1)[0].sentence
