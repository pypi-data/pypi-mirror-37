...
class Reaction(object):
    ...
    COMPOUND_JSON = json.load(
        pkg_resources.resource_stream('equilibrator_api', 'data/cc_compounds.json'))
...
if __name__ == '__main__':
    ...
    print('oxidation energy of glucose: %.2f kJ/mol' % r.dG0_prime())
    
    r = Reaction.get_oxidation_reaction('C00064')
    print(r.write_formula())
    print('oxidation energy of acetate: %.2f kJ/mol' % r.dG0_prime())
    ...
    print(r.write_formula())
    print('oxidation energy of glucose: %s kJ/mol' % r.dG0_prime())
