# https://github.com/mapillary/mapillary_tools/blob/master/python/
...
def get_estimate(time, points, max_dt):

    return interpolate_lat_lon(points=points, t=time, max_dt=max_dt)
