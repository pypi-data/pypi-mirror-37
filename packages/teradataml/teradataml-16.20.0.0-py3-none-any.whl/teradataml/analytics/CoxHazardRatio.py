    ...
    def __init__(self,
        ...
        PARAMETERS:
            ...
            predicts_partition_column:
                Partition By columns for predicts.
        ...
        EXAMPLES:
            ...
            lc_new_predictors_2 = lc_new_predictors.assign(id, name,karno = karno * 1.1 , diagtime = diagtime * 1, age = age * (0.9))
