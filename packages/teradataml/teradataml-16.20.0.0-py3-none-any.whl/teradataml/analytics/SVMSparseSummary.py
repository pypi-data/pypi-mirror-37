...
class SVMSparseSummary:
    ...
    def __init__(self,
        ...
        EXAMPLES:
            ...
            svm_sparse_summary_out = SVMSparseSummary(data=svm_iris_input_train,
                                                    object=svm_train,
                                                    attribute_column='attribute',
                                                    summary=False)
            
            # Print the result DataFrame
            print (svm_sparse_summary_out.result)
