...
from teradataml.analytics.CoxPH import CoxPH
...
class CoxSurvival:
    ...
    def __init__(self,
        ...
        PARAMETERS:
            object:
                Required Argument.
                Specifies the name of the Cox coefficient model table, which was 
                output by the CoxPH function.
            
            cox_model_table:
                Required Argument.
                Specifies the name of the Cox linear predictor model table, which was 
                output by the CoxPH function.
            
            predict_table:
                Required Argument.
                Specifies the name of the predict table, which contains new 
        ...
        EXAMPLES:
            ...
            lungcancer_lp = DataFrame.from_table("lungcancer_lp")
            lungcancer_coef = DataFrame.from_table("lungcancer_coef")
            lc_new_predictors = DataFrame.from_table("lc_new_predictors)
            
            # Example 1 -
            cox_survival_out = CoxSurvival(object = lungcancer_coef,
                                          cox_model_table = lungcancer_lp,
