...
class List(object):
    ...
    def __init__(self, created=None, description=None, facebook=None, from_email=None, from_name=None, id=None, instagram=None, linkedin=None, name=None, subscribe_redirect_url=None, subscribe_url=None, twitter=None, unsubscribe_cascades=True, unsubscribe_redirect_url=None, unsubscribe_url=None, website=None):  # noqa: E501
