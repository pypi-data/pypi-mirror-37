...
is available as `mlhub_1.4.6.tar.gz`_ within the `distribution
folder`_ of the MLHub.

To install from the tar.gz file::
  
  $ wget https://mlhub.ai/dist/mlhub_1.4.6.tar.gz
  $ pip install mlhub_1.4.6.tar.gz
  $ ml

Or extract the above downloaded .tar.gz and install::

  $ wget https://mlhub.ai/dist/mlhub_1.4.6.tar.gz
  $ tar xvf mlhub_1.4.6.tar.gz
  $ cd mlhub
  $ python3 setup.py install --user

.. _`mlhub_1.4.6.tar.gz`: https://mlhub.ai/dist/mlhub_1.4.6.tar.gz
