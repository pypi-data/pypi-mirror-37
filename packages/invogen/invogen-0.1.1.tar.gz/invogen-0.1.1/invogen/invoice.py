...
class Invoice:
    ...
    def __init__(self, customer=Customer()):
        """
        Args:
            customer_accounts (:obj:`Customer`):
                The customer account for this invoice.
                Defaults to an empty instance of :obj:`Customer`.
        """
        self._customer = customer
        self._entries = []
        self._sub_total = Decimal("0.0")
    ...
    def total(self):
        ...
        return self.sub_total + self.shipping - self.discount
