...
class RGB_API(object):
    ...
    def note_session(self):
        '''Note_session list getter'''
        return getattr(self, '__note_session', None)

    @note_session.setter
    def note_session(self, handler):
        '''Note_session list setter'''
        self._set_response_data(handler, '__note_session')
    ...
    def get_note_session(self, note_id, **kwargs):
        params = dict(id=note_id, **kwargs)
        print params
        handler = partial(self.note_session_request, params)
        self.note_session = handler
    ...
    def note_session_request(self, note_data, endpoint='/session'):
        '''GET Request for listing notes session'''
