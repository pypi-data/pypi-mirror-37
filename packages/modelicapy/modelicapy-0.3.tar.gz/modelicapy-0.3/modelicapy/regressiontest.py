...
#
#
# Modified from BuildingsPy (LBNL - MWetter@lbl.gov 2011-02-23)
# Modified by:  Andrew Naylor, Bob Kinoshita, and Scott Greenwood (2017)

# For use of buildingspy regressiontests on Windows (not needed for Linux)
# To use:
# Install buildingsphy: pip install buildingspy
# Replace the existing regressiontest.py file in `buildingspy/development`
# Recompile regressiontest.py
# 	import py_compile
#   py_compile.compile('regressiontest.py')
# Now use buildingspy as usual: i.e., run `\TRANSFORM-Library\regtestsWin_customBuildPy.py`
#######################################################
