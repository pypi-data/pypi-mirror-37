...
metrics=['accuracy','recall','precision','false_alarm','f1']
...
def FFT1(k,train_data,train_labels,test_data,test_labels, metric,print_best):
    dic={}
    dic1={}
    for i in metrics:
        if i == 'f1':
        ...
        if print_best == True:
            ...
            print("All trees")
            for j in range(fft.tree_cnt):
                print("Tree structure:",fft.structures[j])
                description=fft.print_tree(j)
                print(description)
