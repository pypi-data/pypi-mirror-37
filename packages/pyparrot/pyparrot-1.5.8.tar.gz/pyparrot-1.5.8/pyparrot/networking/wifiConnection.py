...
class WifiConnection:
    ...
    def __init__(self, drone, drone_type="Bebop2"):
        ...
        self.udp_send_port = 44444 # defined during the handshake
        ...
        if (drone_type == "Bebop"):
            ...
            #self.mdns_address = "_companion-link._tcp.local."
    ...
    def connect(self, num_retries):
        ...
        # parrot's latest firmware (3.0.26 broke all of the mDNS services so this is (temporarily) commented
    ...
    def _handshake(self, num_retries):
        ...
        # connect
        print("connecting to ")
        #print((self.drone_ip, self.connection_info.port))
