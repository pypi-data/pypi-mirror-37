...
class DataSourceEntity(Model):
    ...
    def __init__(self, data_type_id=None, upload_state=None, data_location=None, identifier_hash=None, name=None,
                 hash=None, description=None, id=None, etag=None, created_date=None, last_modified_date=None,
                 entity_status=None):
