...
class ExperimentEntity(Model):
    ...
    def __init__(self, description=None, status=None, graph_id=None, is_submitted=None, has_errors=None, has_warnings=None, upload_state=None, parameter_assignments=None, run_history_experiment_name=None, pipeline_id=None, id=None, etag=None, created_date=None, last_modified_date=None, entity_status=None):
