...
def main_save():
    ...
    if utils.tf_version_uper_than("1.3.0"):
        scopes.append(scope+"viterbi/cond/Merge")
        scopes.append(scope+"viterbi/cond/Merge_1")
    else:
        scopes.append(scope+"crf/transitions")
    scopes.append(scope+"logits/logits")
    scopes.append(scope+"logits/prob")
