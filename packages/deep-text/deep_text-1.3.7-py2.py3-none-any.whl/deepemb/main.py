...
def main_save():
    ...
    if len(config.gpu_list) > 0:
        scope = "reuse_model/"
    scopes = [scope+'loss/loss',
              scope+'encoder/rnn/while/Exit_3',
              scope+'softmax_prev_prediction/prev_prediction',
              scope+'decoder_prev_prediction/rnn/while/Exit_3',
              scope+'softmax_post_prediction/post_prediction',
              scope+'decoder_post_prediction/rnn/while/Exit_3']
