...
class Rabbit(object):
	...
	def catchRabbit(self, callback, exchange_type = 'direct', durable = True, auto_delete = True, no_ack = True):
	...
	def throwRabbit(self, body, exchange_type = 'direct', durable = True, auto_delete = True):
		credentials = pika.PlainCredentials(self.conn_info['user'], self.conn_info['password'])
		connection = pika.BlockingConnection(
