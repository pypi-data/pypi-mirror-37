    ...
    def add_upstream_target(self, upstream_name, service_host, weight,health):
        ...
        try:
            upstream = {'name':upstream_name,
                        ...
                        'healthchecks.active.healthy.interval':3,
                        'healthchecks.active.unhealthy.interval':3,
                        'healthchecks.active.healthy.successes':5,
                        'healthchecks.active.unhealthy.tcp_failures':2,
                        'healthchecks.active.unhealthy.timeouts':10,
                        'healthchecks.active.unhealthy.http_failures':10
                        }
