...
class GridComponent(Component):
    ...
    def _update_config(self):
        ...
        if (
            ...
            self.enr_tot = np.zeros(self.num_case)   # total energy used [kWh]
            self.pow_nmt = np.zeros(self.num_case)  # net metering power [kW]
            self.enr_nmt = np.zeros(self.num_case)  # total energy sold [kWh]
