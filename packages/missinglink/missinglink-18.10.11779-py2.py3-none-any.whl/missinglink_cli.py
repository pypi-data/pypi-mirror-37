...
class RewritingGroup(click.Group):
    ...
    def parse_args(self, ctx, args):
        ...
        rewrite_map = [
            (('resources', 'install'), ('resource', 'local-grid', 'install')),
            (('aws', 'resource-group'), ('resource', 'group')),
            (('aws', '--region', '.*', 'resource-group'), ('resource', 'group')),
            (('aws',), ('resource', 'aws')),
        ]
...
def add_commands():
    from missinglink.commands import auth_commands, projects_commands, orgs_commands, experiments_commands, code_commands, \
        models_commands, data_commands, run_commands, resources_commands_old, resources_commands, defaults_commands
    ...
    cli.add_command(resources_commands_old)
