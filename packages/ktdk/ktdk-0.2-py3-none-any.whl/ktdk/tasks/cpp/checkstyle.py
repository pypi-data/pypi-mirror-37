...
class ClangFormatFilesTask(Task):
    ...
    @property
    def style(self):
        return self.style or self.context.config['clang_format_style']

    def _run(self, *args, **kwargs):
        for fpath in self.files:
            self.add_task(ClangFormatTask(file=fpath, style=self.style, command=self.command))
...
class ClangFormatTask(CommandTask):
    ...
    @property
    def style(self):
        return self._style or self.context.config['clang_format_style']
    ...
    def _run(self, *args, **kwargs):
        if self._style:
            self.args.extend(['--style', self._style])
