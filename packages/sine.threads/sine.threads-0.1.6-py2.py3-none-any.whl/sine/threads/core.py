...
class StoppableThread(threading.Thread):
    ...
    def __init__(self, group=None, target=None, name=None, args=(),
                 kwargs=None, verbose=None, event_name=None):
        '''
        ...
        if target != None:
            ...
            (len(spec.args) > len(args) and event_name in spec.args[len(args):]):
                if strict and kwargs.has_key(event_name):
...
class ReStartableThread(object):
    ...
    def __init__(self, group=None, target=None, name=None, args=(),
        kwargs=None, verbose=None, event_name=None, processor=_setDaemon):
        '''
        ...
        '''
        self._args = (group, target, name, args, kwargs, verbose, event_name)
    ...
    def _create(self):
        ...
        self._started = False
        self._thread = StoppableThread(*self._args)
        if self._processor:
