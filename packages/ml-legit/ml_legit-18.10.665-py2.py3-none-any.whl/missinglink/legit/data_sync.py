...
class DataSync(object):
    ...
    def _upload_file_for_processing(self, file_obj, file_description, file_type=None):
        ...
        data_object_name = '%s/temp/%s_%s.%s' % (volume_id, file_description, uuid4().hex, file_type or 'json')

        put_url = self._get_secure_url(volume_id, data_object_name)

        self._upload_file(file_obj, put_url, data_object_name, file_description)
    ...
    def _get_secure_url(self, volume_id, data_object_name):
    ...
    def _upload_file(self, file_obj, put_url, data_object_name, file_description):
        ...
        with tqdm(total=file_obj.tell(), desc="Uploading {}".format(file_description), unit='B', ncols=80,
            ...
            do_upload(None, None, None, data_object_name, file_obj, headers, head_url=None, put_url=put_url,
                      callback=update_bar)
