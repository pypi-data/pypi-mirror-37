...
class ProjectsMixin(object):
    ...
    def export_project(self, project_id,
                       ...
                       export_sources=True,
                       export_sources_dataloaders=True,
                       export_trends=True,
                       write_to_disk=False):
        ...
        :param export_sources: Boolean. Whether to include the sources,
            defaults to `True`.
        :param export_sources_dataloaders: Boolean. Whether to include the
            dataloaders, defaults to `True`.
        ...
        export_options = {
            ...
            'export_sources_dataloaders': export_sources_dataloaders,
