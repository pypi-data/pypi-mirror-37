...
setup(
    ...
    packages=["footmark", "footmark.ecs", "footmark.slb", "footmark.vpc", "footmark.rds", "footmark.ess",
              "footmark.oss", "footmark.pyami"],

    # List run-time dependencies here.  These will be installed by pip when
    # your project is installed. For an analysis of "install_requires" vs pip's
    # requirements files see:
    # https://packaging.python.org/en/latest/requirements.html
    install_requires=['aliyun-python-sdk-ecs==4.9.3', 'aliyun-python-sdk-slb==3.2.5', 'aliyun-python-sdk-core==2.8.5',
                      'aliyun-python-sdk-rds==2.1.3', 'aliyun-python-sdk-ess==2.2.1', 'oss2>=2.3.3', 'importlib']
)
