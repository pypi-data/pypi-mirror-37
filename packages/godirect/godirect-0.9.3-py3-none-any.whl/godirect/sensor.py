class GoDirectSensor:
	...
	def __init__(self, info):
		...
		self._sensor_number = channelNumber
		...
		self._measurement_period_granularity = measurementPeriodGranularity
	...
	def measurement_uncertainty(self):
		""" float: the expected uncertainty of each measurement
		"""
		return self._measurement_uncertainty

	@property
	def min_measurement(self):
		""" float: the smallest measurement expected
		"""
		return self._min_measurement

	@property
	def max_measurement(self):
		""" float: the largest measurment expected
		"""
