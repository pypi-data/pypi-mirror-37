...
class TestOptionsValidatorService(object):
  ...
  def test_get_framework_and_resources_without_confirmation(
    ...
    assert gpu_options_validator_service.services.kubectl_service.check_gpu_nodes.call_count == int(bool(
  ...
  def test_get_gpu_framework_without_gpus(self, gpu_options_validator_service):
    ...
    assert gpu_options_validator_service.services.kubectl_service.check_gpu_nodes.call_count == 0
  ...
  def test_get_cpu_framework_with_gpus(self, gpu_options_validator_service):
    ...
    gpu_options_validator_service.services.kubectl_service.check_gpu_nodes.assert_called_with(2)
