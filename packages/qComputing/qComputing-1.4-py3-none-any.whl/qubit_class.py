...
class Qubit(object):
    ...
    Qubitobj class.
    """
    def __init__(self, string,  n, no_measurment_qubits=1):
        """
        ...
        self.projectors = {i: op.superkron(oper_dict, val=1, string=i) for i in self.measurement_string}
...
if __name__ == '__main__':
     ...
     q2 = Qubit(init, 2, no_measurment_qubits=1)
