...
async def module_states(**kwargs):
    ...
    Keyword Args:
        api-host: The host of the FASva-RESTfull API
        api-user: User name for basic authentication
        api-password:  User password for basic authentication
    ...
    async with aiohttp.ClientSession() as session:
        ...
        async with session.get(**params) as response:
            ...
            for prop in ['process', 'current', 'unprocessed']:
