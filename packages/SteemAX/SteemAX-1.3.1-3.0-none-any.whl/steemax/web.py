    ...
    def invite(self, token, account2, per,
        ...
        if self.verify_token(sec.filter_token(token)):
            ...
            if self.steem.account(account2) is False:
                ...
                if verify.eligible_votes(self.steem.username, account2, percentage, ratio, 1) is False:
