...
def execute_callbacks(
    queue, callbacks, method, original, args=None, kwargs=None
):
...
def execute_failing_callbacks(
    key, strategy, original, exc_infos, args=None, kwargs=None
):
...
def execute_post_callbacks(
    key, strategy, original, result, args=None, kwargs=None
):
