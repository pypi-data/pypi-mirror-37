...
def cut_train(box, source_folder='dataset/source_train', target_folder='dataset/train'):
    cut_images(box, source_folder, target_folder)


def cut_test(box, source_folder='dataset/source_test', target_folder='dataset/test'):
    cut_images(box, source_folder, target_folder)
