...
####+END:
    ...
    icm.ex_gExecMenuItem(execLine="""ls -l /bisos/vc/git""")   
    icm.ex_gExecMenuItem(execLine="""sudo mkdir /bisos/vc/git; sudo chown {}:{} /bxRepos"""
...
####+BEGIN: bx:dblock:python:func :funcName "pbdDict_bxReposRoot" :comment "pbd Dictionary" :funcType "Init" :retType "bxReposRootBaseDirsDict" :argsList "baseDir" :deco ""
"""
...
*** See: \section{/bxRepos Bases Directory Structure Overview}
    ...
    command(  'unisos-pip/x822Msg',
              "cd {root}/unisos-pip; git clone https://{gitUserName}:{gitPasswd}@github.com/unisos-pip/x822"
              .format(root=root, gitUserName=gitUserName, gitPasswd=gitPasswd))
