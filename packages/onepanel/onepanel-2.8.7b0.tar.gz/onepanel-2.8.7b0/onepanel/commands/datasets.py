...
def general_push(ctx,comment='',name='',suppress_output=False):
    ...
    url_dataset_member_check = '/accounts/{}/datasets/{}/is_member'.format(vc.conn.account_uid, vc.dataset_uid)
    response_data = vc.get(uid='', field_path='', params=url_dataset_member_check)
