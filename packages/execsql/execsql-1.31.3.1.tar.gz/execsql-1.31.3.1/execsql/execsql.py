...
metacommands.append(MetaCommand(r'^\s*PROMPT\s+OPENFILE\s+SUB\s+(?P<match>~?\w+)(?:\s+(?P<fullpath>FULLPATH))?\s*$', x_prompt_openfile))
...
metacommands.append(MetaCommand(r'^\s*PROMPT\s+SAVEFILE\s+SUB\s+(?P<match>~?\w+)(?:\s+(?P<fullpath>FULLPATH))?\s*$', x_prompt_savefile))
