...
class MessageEnumTraits(EnumTraits):
  ...
  __slots__ = ['__allow_broadcast', '__products', '__substrates', '__not_broadcastable_reason']

  def __init__(self, value, name, allow_broadcast=True, not_bcastable_reason='', yields_dict=None):
