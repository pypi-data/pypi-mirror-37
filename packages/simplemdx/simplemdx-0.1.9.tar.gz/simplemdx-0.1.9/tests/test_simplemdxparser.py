...
from simplemdx.declparser import mdxCycle, mdxParser, mdxStream, mdxTrial, coordToSegments, segmentsToCoord
    ...
    def test_coords(self, d):
        ...
        with pytest.raises(ValueError):
            assert segmentsToCoord(
                d['data'], coord, d['coords'], d['scaleFactor'], d['nFrames']) == d['result']
