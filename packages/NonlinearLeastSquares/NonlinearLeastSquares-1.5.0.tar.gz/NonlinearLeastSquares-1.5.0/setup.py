...
setup(name='NonlinearLeastSquares',
      ...
      url='https://engineering.purdue.edu/kak/distNonlinearLeastSquares/NonlinearLeastSquares-1.5.0.html',
      download_url='https://engineering.purdue.edu/kak/distNonlinearLeastSquares/NonlinearLeastSquares-1.5.0.tar.gz', 
      description='A Python module for solving optimization problems with nonlinear least-squares',
      long_description=''' 

Consult the module API page at 

      https://engineering.purdue.edu/kak/distNonlinearLeastSquares/NonlinearLeastSquares-1.5.0.html
...
you take multiple images of a scene with a calibrated camera
--- something that you can simulate with
**ProjectiveCamera**.  You feed the pixels thus recorded
into the NonlinearLeastSquares class to estimate the
coordinates of the scene structure.
