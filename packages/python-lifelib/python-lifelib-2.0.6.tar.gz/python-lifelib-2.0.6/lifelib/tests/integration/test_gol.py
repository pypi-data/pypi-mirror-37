...
class TestGoL(unittest.TestCase):
    ...
    def test_io(self):
        ...
        try:
            ...
            lidka.save('lifelib/tempdir/lidka.rle')
            lidka.save('lifelib/tempdir/lidka.rle.gz')
            lidka.save('lifelib/tempdir/lidka.mc')
            lidka.save('lifelib/tempdir/lidka.mc.gz')
            ...
            lr = self.lt.load('lifelib/tempdir/lidka.rle')
            lrz = self.lt.load('lifelib/tempdir/lidka.rle.gz')
            lm = self.lt.load('lifelib/tempdir/lidka.mc')
            lmz = self.lt.load('lifelib/tempdir/lidka.mc.gz')
