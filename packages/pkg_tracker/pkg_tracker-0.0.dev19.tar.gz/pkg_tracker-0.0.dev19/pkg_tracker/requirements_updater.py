...
class RequirementsUpdater:
    ...
    def _pure_new_packages(self, old_packages, new_packages):
        ...
        return '\n'.join(
            [pkg_row for pkg_row in self._packages_to_list(new_packages) if not self._is_extra_pkg(pkg_row)]
        )
    ...
    @ staticmethod
    def _is_extra_pkg(pkg, extra_pkg_list):
