...
class MessageGameToEngine(object):
  ...
  class Tag(object):
    ...
    SaveCalibrationImage                    = 0xea # Anki.Cozmo.ExternalInterface.SaveCalibrationImage
    ClearCalibrationImages                  = 0xeb # Anki.Cozmo.ExternalInterface.ClearCalibrationImages
    ComputeCameraCalibration                = 0xec # Anki.Cozmo.ExternalInterface.ComputeCameraCalibration
    ContinueFreeplayFromIdle                = 0xed # Anki.Cozmo.ExternalInterface.ContinueFreeplayFromIdle
    EnableDroneMode                         = 0xee # Anki.Cozmo.ExternalInterface.EnableDroneMode
    EnterSdkMode                            = 0xef # Anki.Cozmo.ExternalInterface.EnterSdkMode
    ExitSdkMode                             = 0xf0 # Anki.Cozmo.ExternalInterface.ExitSdkMode
    SetStopRobotOnSdkDisconnect             = 0xf1 # Anki.Cozmo.ExternalInterface.SetStopRobotOnSdkDisconnect
    StopRobotForSdk                         = 0xf2 # Anki.Cozmo.ExternalInterface.StopRobotForSdk
    SetShouldAutoConnectToCubesAtStart      = 0xf3 # Anki.Cozmo.ExternalInterface.SetShouldAutoConnectToCubesAtStart
    SetShouldAutoDisconnectFromCubesAtEnd   = 0xf4 # Anki.Cozmo.ExternalInterface.SetShouldAutoDisconnectFromCubesAtEnd
    TransferFile                            = 0xf5 # Anki.Cozmo.ExternalInterface.TransferFile
    NVStorageEraseEntry                     = 0xf6 # Anki.Cozmo.ExternalInterface.NVStorageEraseEntry
    NVStorageWipeAll                        = 0xf7 # Anki.Cozmo.ExternalInterface.NVStorageWipeAll
    NVStorageWriteEntry                     = 0xf8 # Anki.Cozmo.ExternalInterface.NVStorageWriteEntry
    NVStorageClearPartialPendingWriteEntry  = 0xf9 # Anki.Cozmo.ExternalInterface.NVStorageClearPartialPendingWriteEntry
    NVStorageReadEntry                      = 0xfa # Anki.Cozmo.ExternalInterface.NVStorageReadEntry
    SetCameraSettings                       = 0xfb # Anki.Cozmo.ExternalInterface.SetCameraSettings
    RequestRobotSettings                    = 0xfc # Anki.Cozmo.ExternalInterface.RequestRobotSettings
  ...
  _tags_by_name = dict(
    ...
    SaveCalibrationImage=234,
    ClearCalibrationImages=235,
    ComputeCameraCalibration=236,
    ContinueFreeplayFromIdle=237,
    EnableDroneMode=238,
    EnterSdkMode=239,
    ExitSdkMode=240,
    SetStopRobotOnSdkDisconnect=241,
    StopRobotForSdk=242,
    SetShouldAutoConnectToCubesAtStart=243,
    SetShouldAutoDisconnectFromCubesAtEnd=244,
    TransferFile=245,
    NVStorageEraseEntry=246,
    NVStorageWipeAll=247,
    NVStorageWriteEntry=248,
    NVStorageClearPartialPendingWriteEntry=249,
    NVStorageReadEntry=250,
    SetCameraSettings=251,
    RequestRobotSettings=252,
  )
  ...
  _tags_by_value[234] = 'SaveCalibrationImage'
  _tags_by_value[235] = 'ClearCalibrationImages'
  _tags_by_value[236] = 'ComputeCameraCalibration'
  _tags_by_value[237] = 'ContinueFreeplayFromIdle'
  _tags_by_value[238] = 'EnableDroneMode'
  _tags_by_value[239] = 'EnterSdkMode'
  _tags_by_value[240] = 'ExitSdkMode'
  _tags_by_value[241] = 'SetStopRobotOnSdkDisconnect'
  _tags_by_value[242] = 'StopRobotForSdk'
  _tags_by_value[243] = 'SetShouldAutoConnectToCubesAtStart'
  _tags_by_value[244] = 'SetShouldAutoDisconnectFromCubesAtEnd'
  _tags_by_value[245] = 'TransferFile'
  _tags_by_value[246] = 'NVStorageEraseEntry'
  _tags_by_value[247] = 'NVStorageWipeAll'
  _tags_by_value[248] = 'NVStorageWriteEntry'
  _tags_by_value[249] = 'NVStorageClearPartialPendingWriteEntry'
  _tags_by_value[250] = 'NVStorageReadEntry'
  _tags_by_value[251] = 'SetCameraSettings'
  _tags_by_value[252] = 'RequestRobotSettings'
  ...
  _tag_unpack_methods[234] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SaveCalibrationImage.unpack_from)
  _tag_unpack_methods[235] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ClearCalibrationImages.unpack_from)
  _tag_unpack_methods[236] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ComputeCameraCalibration.unpack_from)
  _tag_unpack_methods[237] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ContinueFreeplayFromIdle.unpack_from)
  _tag_unpack_methods[238] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableDroneMode.unpack_from)
  _tag_unpack_methods[239] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnterSdkMode.unpack_from)
  _tag_unpack_methods[240] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ExitSdkMode.unpack_from)
  _tag_unpack_methods[241] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetStopRobotOnSdkDisconnect.unpack_from)
  _tag_unpack_methods[242] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StopRobotForSdk.unpack_from)
  _tag_unpack_methods[243] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetShouldAutoConnectToCubesAtStart.unpack_from)
  _tag_unpack_methods[244] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetShouldAutoDisconnectFromCubesAtEnd.unpack_from)
  _tag_unpack_methods[245] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TransferFile.unpack_from)
  _tag_unpack_methods[246] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageEraseEntry.unpack_from)
  _tag_unpack_methods[247] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageWipeAll.unpack_from)
  _tag_unpack_methods[248] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageWriteEntry.unpack_from)
  _tag_unpack_methods[249] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageClearPartialPendingWriteEntry.unpack_from)
  _tag_unpack_methods[250] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageReadEntry.unpack_from)
  _tag_unpack_methods[251] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetCameraSettings.unpack_from)
  _tag_unpack_methods[252] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestRobotSettings.unpack_from)
  ...
  _type_by_tag_value[234] = lambda : Anki.Cozmo.ExternalInterface.SaveCalibrationImage
  _type_by_tag_value[235] = lambda : Anki.Cozmo.ExternalInterface.ClearCalibrationImages
  _type_by_tag_value[236] = lambda : Anki.Cozmo.ExternalInterface.ComputeCameraCalibration
  _type_by_tag_value[237] = lambda : Anki.Cozmo.ExternalInterface.ContinueFreeplayFromIdle
  _type_by_tag_value[238] = lambda : Anki.Cozmo.ExternalInterface.EnableDroneMode
  _type_by_tag_value[239] = lambda : Anki.Cozmo.ExternalInterface.EnterSdkMode
  _type_by_tag_value[240] = lambda : Anki.Cozmo.ExternalInterface.ExitSdkMode
  _type_by_tag_value[241] = lambda : Anki.Cozmo.ExternalInterface.SetStopRobotOnSdkDisconnect
  _type_by_tag_value[242] = lambda : Anki.Cozmo.ExternalInterface.StopRobotForSdk
  _type_by_tag_value[243] = lambda : Anki.Cozmo.ExternalInterface.SetShouldAutoConnectToCubesAtStart
  _type_by_tag_value[244] = lambda : Anki.Cozmo.ExternalInterface.SetShouldAutoDisconnectFromCubesAtEnd
  _type_by_tag_value[245] = lambda : Anki.Cozmo.ExternalInterface.TransferFile
  _type_by_tag_value[246] = lambda : Anki.Cozmo.ExternalInterface.NVStorageEraseEntry
  _type_by_tag_value[247] = lambda : Anki.Cozmo.ExternalInterface.NVStorageWipeAll
  _type_by_tag_value[248] = lambda : Anki.Cozmo.ExternalInterface.NVStorageWriteEntry
  _type_by_tag_value[249] = lambda : Anki.Cozmo.ExternalInterface.NVStorageClearPartialPendingWriteEntry
  _type_by_tag_value[250] = lambda : Anki.Cozmo.ExternalInterface.NVStorageReadEntry
  _type_by_tag_value[251] = lambda : Anki.Cozmo.ExternalInterface.SetCameraSettings
  _type_by_tag_value[252] = lambda : Anki.Cozmo.ExternalInterface.RequestRobotSettings
