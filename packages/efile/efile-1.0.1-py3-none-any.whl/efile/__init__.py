...
def encode(file_path):
    ...
    print('Encoded file is {}'.format(new_filename))
...
def decode(file_path):
    ...
    with open(file_path, mode='rb') as f:
        ...
        if os.path.exists(filename):
            print('{} has exists.'.format(filename))
            filename = 'efile_' + filename
            print('It will be rename to {}'.format(filename))
        else:
            print('Decoded file is {}'.format(filename))
