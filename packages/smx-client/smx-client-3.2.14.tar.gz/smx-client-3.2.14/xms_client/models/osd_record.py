...
class OsdRecord(object):
    ...
    def __init__(self, action_status=None, create=None, data_dir=None, disk=None, host=None, id=None, _in=None, init_time=None, last_scrub_time=None, meta_bytes=None, name=None, osd_id=None, partition=None, pool=None, read_cache_size=None, role=None, status=None, type=None, up=None, update=None, uuid=None, samples=None):  # noqa: E501
