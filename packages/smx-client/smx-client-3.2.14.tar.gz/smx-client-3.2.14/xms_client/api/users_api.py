...
class UsersApi(object):
    ...
    def update_user_0(self, user_id, body, **kwargs):  # noqa: E501
        """update_user_0  # noqa: E501

        update user info  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_user_0(user_id, body, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.update_user_0_with_http_info(user_id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.update_user_0_with_http_info(user_id, body, **kwargs)  # noqa: E501
            return data

    def update_user_0_with_http_info(self, user_id, body, **kwargs):  # noqa: E501
        """update_user_0  # noqa: E501

        update user info  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_user_0_with_http_info(user_id, body, async=True)
        >>> result = thread.get()
        ...
        if ('user_id' not in params or
                params['user_id'] is None):
            raise ValueError("Missing the required parameter `user_id` when calling `update_user_0`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_user_0`")  # noqa: E501
