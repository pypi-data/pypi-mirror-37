...
# Helper function
def register_single_worker(toplevel_workdir, master_endpoint, base_port, is_gpu_worker, resource_id):
    port = base_port
    ...
    register_is_success, worker_uuid = worker.register(is_gpu_worker, resource_id)
...
def register(master_endpoint, metafile, toplevel_workdir, cpu_worker_count, gpu_count, gpu_worker_count):
