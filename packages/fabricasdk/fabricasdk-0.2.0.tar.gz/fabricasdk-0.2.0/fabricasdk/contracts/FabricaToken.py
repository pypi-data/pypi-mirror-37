...
class FabricaToken(Contract):
    ...
    def mint(
        ...
        if isinstance(token_metadata, dict):
            ...
            if "image" not in token_metadata:
                token_metadata["image"] = '{}/programmatic/getMapImage/{}'.format(self.api.fabrica_api_url, geohash)
    ...
    # todo
    def update_token(self, *args, cosign=True, customer_address=None, **kwargs):
        return self.update_token_raw(*args, cosign=cosign, customer_address=customer_address, **kwargs)
