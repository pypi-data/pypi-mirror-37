...
Basic usage:
    ...
    >>> import markdown
    >>> text = "# Some Header #"
    >>> md = markdown.markdown(text, ['headerid_github'])
    >>> print md
...
To fit within a html template's hierarchy, set the header base level:
    ...
    ... #Some Header
    ... ## Next Level'''
    >>> md = markdown.markdown(text, ['headerid_github(level=3)'])
    >>> print md
...
Turn off auto generated IDs:
    ...
    ... # Some Header
    ... # Another Header'''
    >>> md = markdown.markdown(text, ['headerid_github(forceid=False)'])
    >>> print md
    <h1>Some Header</h1>
...
Use with MetaData extension:
    ...
    ...
    ... # A Header'''
    >>> md = markdown.markdown(text, ['headerid_github', 'meta'])
    >>> print md
    <h2>A Header</h2>
...
from markdown.util import HTML_PLACEHOLDER_RE, parseBoolValue
...
def unique(id, ids):
    """ Ensure id is unique in set of ids. Append '-1', '-2'... if not """
...
class HeaderIdGithubExtension(Extension):
...
def makeExtension(configs={}):
    return HeaderIdGithubExtension(configs=configs)
