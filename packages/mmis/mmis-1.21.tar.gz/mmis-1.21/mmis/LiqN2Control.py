...
class Settings(wx.Panel):
    ...
    def __init__(self, parent, Module, pubsub1, pubsub2):
        ...
        self.SET_Rewound = wx.SpinCtrlDouble(self, size=(150,40), min = 0.5, max = 2.5, inc = 0.1, value='1.65', pos = (480,20))
        ...
        self.SET_UL = wx.SpinCtrlDouble(self, size=(100,40), min = 0, max = 3.0, inc = 0.01, value='2.0', pos = (325,180))
        ...
        self.SET_LL = wx.SpinCtrlDouble(self, size=(100,40), min = 0, max = 3.0, inc = 0.01, value='1.0', pos = (545,180))
    ...
    def on_redraw_timer(self, e):
        ...
        self.Alarm = c.Alarm
        Cap = c.Float.Float[0]
        self.Capacitance.SetValue(str(Cap))
...
class Main(wx.Panel):
    ...
    def __init__(self, parent, Module, pubsub1, pubsub2):
        ...
        self.button6.SetBackgroundColour(wx.Colour(211,211,211))
        self.one = wx.SpinCtrlDouble(self, size=(85,35), min = 0, max = 2, inc = 0.001, value='1.75')
    ...
    def on_get_read_timer(self, e):
        self.x = self.Temperature_Acquisition()
        self.two.SetValue(str(self.x[0])[:5])
        self.five.SetValue(str(self.x[1])[:6])
