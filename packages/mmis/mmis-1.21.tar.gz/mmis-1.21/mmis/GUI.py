...
#ImgFolder = '/home/pi/Desktop/GUI10.0/Images/'


class SaveData(wx.Frame):
    def __init__(self, excelfile):
        wx.Frame.__init__(self, None, wx.ID_ANY, title = "Save", size = (200,200) ,style = wx.DEFAULT_FRAME_STYLE | wx.FULL_REPAINT_ON_RESIZE)
        panel = wx.Panel(self)
        
        self.Maximize(True)
        self.workbook = excelfile
        txt = wx.StaticText(panel, label = "Do you want to Save data and close the log file?", pos = (20,55))
        self.button1 = wx.Button(self, label="YES", pos=(80, 55), size = (100,40), id = -1)
        #self.button4.SetFont(self.font2)
        self.Bind(wx.EVT_BUTTON, self.ON_SAVEDATA,self.button1)
        self.button1.SetForegroundColour('black')

    def ON_SAVEDATA(self, evt):
        self.workbook.close()
...
class TabSettings(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        self.image_file = ImgFolder+'Logo.png'
        self.Logo.SetFocus()
...
class TabOne(wx.Frame):
    def __init__(self, parent):
        wx.Frame.__init__(self,parent,wx.ID_ANY,"Loading",size=(400,400))
...
class MainWindow(wx.Frame):
    ...
    def Create_Menubar(self):
        ...
        helpmenu = wx.Menu()
        generalhelp = helpmenu.Append(1, "&StartUp", "General help on StartUp, Recovery mode and System update")
        ...
        helpmenu.AppendSeparator()
        LN2Controlhelp = helpmenu.Append(3, "&LN2 Control", "Help on using the Liquid N2 Control")
    ...
    def OnAbout(self,e):
        ...
        self.about.SetName("Temperature Control and Monitoring")
    ...
    def Ondualheater(self,e):
        "opens a help file"
        T0 = "PROCEDURE: \n"
        T1 = "1) Ambient and Nitrogen Control default proportional constant and Integral constants are already\n"
        ...
        T11 = "11) The indicators TA and TN2 indicate the respective current temperature\n"
