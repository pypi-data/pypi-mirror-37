...
from apimaticdemonstration1234.api_helper import APIHelper
from apimaticdemonstration1234.models.send_messages_request import SendMessagesRequest
...
class MessagesControllerTests(ControllerTestBase):
    ...
    def test_send_messages_1(self):
        ...
        body = APIHelper.json_deserialize(
            '{"messages":[{"callback_url":"https://my.callback.url.com","content":"My f'
            'irst message","destination_number":"+61491570156","delivery_report":true,"f'
            'ormat":"SMS","message_expiry_timestamp":"2016-11-03T11:49:02.807Z","metadat'
            'a":{"key1":"value1","key2":"value2"},"scheduled":"2016-11-03T11:49:02.807Z"'
            ',"source_number":"+61491570157","source_number_type":"INTERNATIONAL"},{"cal'
            'lback_url":"https://my.callback.url.com","content":"My second message","des'
            'tination_number":"+61491570158","delivery_report":true,"format":"MMS","medi'
            'a":["https://images.pexels.com/photos/1018350/pexels-photo-1018350.jpeg?cs='
            'srgb&dl=architecture-buildings-city-1018350.jpg"],"message_expiry_timestamp'
            '":"2016-11-03T11:49:02.807Z","metadata":{"key1":"value1","key2":"value2"},"'
            'scheduled":"2016-11-03T11:49:02.807Z","source_number":"+61491570159","sourc'
            'e_number_type":"INTERNATIONAL"}]}'
            , SendMessagesRequest.from_dictionary)

        # Perform the API call through the SDK function
        result = self.controller.create_send_messages(content_type, accept, body)
