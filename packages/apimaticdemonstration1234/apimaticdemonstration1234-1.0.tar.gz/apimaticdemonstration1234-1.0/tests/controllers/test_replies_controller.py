...
from apimaticdemonstration1234.models.confirm_replies_as_received_request import ConfirmRepliesAsReceivedRequest
...
class RepliesControllerTests(ControllerTestBase):
    ...
    def test_check_replies_1(self):
        ...
        result = self.controller.get_check_replies(content_type, accept)
    ...
    def test_confirm_replies_as_received_1(self):
        ...
        body = APIHelper.json_deserialize(
            '{"reply_ids":["011dcead-6988-4ad6-a1c7-6b6c68ea628d","3487b3fa-6586-4979-a'
            '233-2d1b095c7718","ba28e94b-c83d-4759-98e7-ff9c7edb87a1"]}'
            , ConfirmRepliesAsReceivedRequest.from_dictionary)

        # Perform the API call through the SDK function
        result = self.controller.create_confirm_replies_as_received(content_type, accept, body)
