...
from ..exceptions.send_messages_400_response_exception import SendMessages400ResponseException
from ..exceptions.api_exception import APIException

class MessagesController(BaseController):

    """A Controller to access Endpoints in the apimaticdemonstration1234 API."""
    ...
    def get_message_status(self,
        ...
        *Note: If an invalid or non existent message ID parameter is specified
        ...
        Returns:
            mixed: Response from the API. The submitted message including the
