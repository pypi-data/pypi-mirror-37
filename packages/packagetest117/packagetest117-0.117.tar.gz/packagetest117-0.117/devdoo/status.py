...
class Status:
    ...
    def __init__(self):
        ...
        # Mensagens de inicialização dos serviços
        self.show_messages = {
            "MONGO_CLIENT": {
        ...
        self.error_messages = {
            ...
            "NO_DATA_TO_UPDATE": {
                "code": 34545645632,
                "message": "Nao foi enviado dados para ser atualizado na base de dados.",
    ...
    # __add
    # --------------------------------
    def __add(self, code, value, params):
