...
`}static get properties(){return{hass:{type:Object},progress:{type:Boolean,value:!1},disabled:{type:Boolean,value:!1}}}tempClass(className){var classList=this.$.container.classList;classList.add(className);setTimeout(()=>{classList.remove(className)},1e3)}ready(){super.ready();this.addEventListener("click",ev=>this.buttonTapped(ev))}buttonTapped(ev){if(this.progress)ev.stopPropagation()}actionSuccess(){this.tempClass("success")}actionError(){this.tempClass("error")}computeDisabled(disabled,progress){return disabled||progress}}customElements.define("ha-progress-button",HaProgressButton)},282:function(module,__webpack_exports__,__webpack_require__){"use strict";var _polymer_lit_element__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(229),_ha_progress_button_js__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(208),_common_dom_fire_event_js__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__(94);class HaCallApiButton extends _polymer_lit_element__WEBPACK_IMPORTED_MODULE_0__.a{render(){return _polymer_lit_element__WEBPACK_IMPORTED_MODULE_0__.c`
    ...
    `}constructor(){super();this.method="POST";this.data={};this.disabled=!1;this.progress=!1}static get properties(){return{hass:{},progress:Boolean,path:String,method:String,data:{},disabled:Boolean}}get progressButton(){return this.renderRoot.querySelector("ha-progress-button")}async _buttonTapped(){this.progress=!0;const eventData={method:this.method,path:this.path,data:this.data};try{const resp=await this.hass.callApi(this.method,this.path,this.data);this.progress=!1;this.progressButton.actionSuccess();eventData.success=!0;eventData.response=resp}catch(err){this.progress=!1;this.progressButton.actionError();eventData.success=!1;eventData.response=err}Object(_common_dom_fire_event_js__WEBPACK_IMPORTED_MODULE_2__.a)(this,"hass-api-called",eventData)}}customElements.define("ha-call-api-button",HaCallApiButton)},639:function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);var app_route=__webpack_require__(89),utils_async=__webpack_require__(8),debounce=__webpack_require__(15),html_tag=__webpack_require__(0),polymer_element=__webpack_require__(4),ha_config_section=__webpack_require__(200),paper_button=__webpack_require__(54),paper_card=__webpack_require__(153),paper_item_body=__webpack_require__(197),paper_toggle_button=__webpack_require__(158),ha_call_api_button=__webpack_require__(282),hass_subpage=__webpack_require__(207),ha_style=__webpack_require__(121),format_date_time=__webpack_require__(77),events_mixin=__webpack_require__(14),localize_mixin=__webpack_require__(9);class ha_config_cloud_account_HaConfigCloudAccount extends Object(events_mixin.a)(Object(localize_mixin.a)(polymer_element.a)){static get template(){return html_tag.a`
    <style include="iron-flex ha-style">
      [slot=introduction] {
        margin: -1em 0;
      }
...
//# sourceMappingURL=94136d17cbd5af8e3ab4.chunk.js.map