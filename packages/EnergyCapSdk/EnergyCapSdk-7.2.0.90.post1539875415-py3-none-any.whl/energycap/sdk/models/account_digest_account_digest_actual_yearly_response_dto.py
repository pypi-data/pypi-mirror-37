...
class AccountDigestAccountDigestActualYearlyResponseDTO(Model):
    ...
    :type results:
     list[~energycap.sdk.models.AccountDigestAccountDigestActualYearlyResponseDTOResultsDTO]
    :param commodities: An array of yearly data per commodity
    :type commodities:
     list[~energycap.sdk.models.AccountDigestAccountDigestActualYearlyResponseDTOCommodityDataDTO]
    """
    ...
    _attribute_map = {
        ...
        'results': {'key': 'results', 'type': '[AccountDigestAccountDigestActualYearlyResponseDTOResultsDTO]'},
        'commodities': {'key': 'commodities', 'type': '[AccountDigestAccountDigestActualYearlyResponseDTOCommodityDataDTO]'},
    }
    ...
    def __init__(self, account_code=None, account_info=None, account_id=None, global_use_unit=None, cost_unit=None, updated=None, results=None, commodities=None):
        super(AccountDigestAccountDigestActualYearlyResponseDTO, self).__init__()
