...
class PreferenceDto(Model):
    ...
    :type group_display_setting: ~energycap.sdk.models.GroupDisplaySettingDto
    ...
    :type workflow_display_setting:
     ~energycap.sdk.models.WorkflowDisplaySettingDto
    """
    ...
    _attribute_map = {
        ...
        'group_display_setting': {'key': 'groupDisplaySetting', 'type': 'GroupDisplaySettingDto'},
        ...
        'workflow_display_setting': {'key': 'workflowDisplaySetting', 'type': 'WorkflowDisplaySettingDto'},
    }
    ...
    def __init__(self, meters_show_inactive=None, show_data_source=None, building_tree_display_setting=None, accounts_show_inactive=None, cost_center_tree_display_setting=None, building_tree_group_to_display=None, vendor_tree_display_setting=None, weather_degree_unit=None, view_vendors_tree_by_commodity=None, group_display_setting=None, bill_list_rows_per_page=None, date_format=None, time_format=None, time_zone_code=None, trend_chart_number_of_years=None, language=None, building_and_organization_identifier=None, meter_identifier=None, account_identifier=None, other_identifier=None, help_open=None, workflow_display_setting=None):
        super(PreferenceDto, self).__init__()
