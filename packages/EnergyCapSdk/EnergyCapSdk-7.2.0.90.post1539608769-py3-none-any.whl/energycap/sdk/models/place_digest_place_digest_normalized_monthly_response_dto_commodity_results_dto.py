...
class PlaceDigestPlaceDigestNormalizedMonthlyResponseDTOCommodityResultsDTO(Model):
    ...
    def __init__(self, period_name=None, calendar_period=None, calendar_year=None, fiscal_period=None, fiscal_year=None, cumulative_common_use=None, global_use=None, common_use=None, common_demand=None):
        super(PlaceDigestPlaceDigestNormalizedMonthlyResponseDTOCommodityResultsDTO, self).__init__()
