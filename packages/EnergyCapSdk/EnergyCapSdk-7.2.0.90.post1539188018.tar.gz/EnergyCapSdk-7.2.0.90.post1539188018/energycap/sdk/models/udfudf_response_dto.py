...
class UDFUDFResponseDTO(Model):
    ...
    :type udf_select_values:
     list[~energycap.sdk.models.UDFUDFSelectValueResponseDTO]
    :param count:
    :type count: int
    """
    ...
    _attribute_map = {
        ...
        'udf_select_values': {'key': 'udfSelectValues', 'type': '[UDFUDFSelectValueResponseDTO]'},
    ...
    def __init__(self, udf_id=None, name=None, udf_type=None, data_type=None, display_order=None, udf_select_values=None, count=None):
        super(UDFUDFResponseDTO, self).__init__()
        self.udf_id = udf_id
        self.name = name
