...
class ChargebackNewChargebackProcessorChargebackProcessorSettingsWithoutFiltersDTO(Model):
    ...
    def __init__(self, billing_period, batch_settings=None, start_date_for_bill=None, end_date_for_bill=None, note=None):
        super(ChargebackNewChargebackProcessorChargebackProcessorSettingsWithoutFiltersDTO, self).__init__()
