...
class LogicalDeviceMeterCalendarizedUseVsWeatherResponseDTO(Model):
    ...
    :param use_unit: The use unit on this meter
    ...
    def __init__(self, year=None, is_heating_weather_sensitive=None, winter_balance_point=None, heating_base_use_per_day=None, heating_weather_factor=None, is_cooling_weather_sensitive=None, summer_balance_point=None, cooling_base_use_per_day=None, cooling_weather_factor=None, use_unit=None):
        super(LogicalDeviceMeterCalendarizedUseVsWeatherResponseDTO, self).__init__()
        self.year = year
