...
class ImportReadingImportProfileRequestDTO(Model):
    ...
    :param estimated: A column number and value to look for to determine if a
     reading should be marked as estimated
     If null, estimated on the reading will default to false
    ...
    def __init__(self, profile_code, delimiter, number_of_header_rows, number_of_columns, channel_interval_in_seconds=None, timestamp_column_number=None, timestamp_format=None, date_column_number=None, time_column_number=None, date_format=None, time_format=None, time_zone_id=None, meter_import_id_column_number=None, channel_import_id_column_number=None, data_mapping=None, estimated=None, note_column_number=None):
        super(ImportReadingImportProfileRequestDTO, self).__init__()
