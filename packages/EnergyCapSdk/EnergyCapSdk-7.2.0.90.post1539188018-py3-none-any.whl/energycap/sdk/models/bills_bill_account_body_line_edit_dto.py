...
class BillsBillAccountBodyLineEditDTO(Model):
    """BillsBillAccountBodyLineEditDTO.

    :param body_line_id: The bodyline's id for an existing bodyline
    ...
    def __init__(self, observation_type_id, caption, body_line_id=None, special_charge_id=None, cost_unit_id=None, cost=None):
        super(BillsBillAccountBodyLineEditDTO, self).__init__()
