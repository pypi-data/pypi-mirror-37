...
class GroupPlaceCategoryResponseDTO(Model):
    ...
    def __init__(self, place_group_category_id=None, place_group_category_code=None, place_group_category_info=None, auto_group=None, number_of_groups=None):
        super(GroupPlaceCategoryResponseDTO, self).__init__()
