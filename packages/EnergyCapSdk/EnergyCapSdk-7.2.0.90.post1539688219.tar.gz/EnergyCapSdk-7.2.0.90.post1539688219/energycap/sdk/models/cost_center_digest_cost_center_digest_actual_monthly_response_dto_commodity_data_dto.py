...
class CostCenterDigestCostCenterDigestActualMonthlyResponseDTOCommodityDataDTO(Model):
    ...
    :type results:
     list[~energycap.sdk.models.CostCenterDigestCostCenterDigestActualMonthlyResponseDTOCommodityResultsDTO]
    """
    ...
    _attribute_map = {
        ...
        'results': {'key': 'results', 'type': '[CostCenterDigestCostCenterDigestActualMonthlyResponseDTOCommodityResultsDTO]'},
    }
    ...
    def __init__(self, commodity_code=None, commodity_info=None, commodity_id=None, common_use_unit=None, cost_unit=None, results=None):
        super(CostCenterDigestCostCenterDigestActualMonthlyResponseDTOCommodityDataDTO, self).__init__()
