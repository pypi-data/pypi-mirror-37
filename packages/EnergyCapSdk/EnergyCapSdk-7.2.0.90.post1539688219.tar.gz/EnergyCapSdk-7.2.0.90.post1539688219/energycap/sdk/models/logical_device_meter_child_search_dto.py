...
class LogicalDeviceMeterChildSearchDTO(Model):
    ...
    :param meter_address: The meter's address
    :type meter_address: ~energycap.sdk.models.AccountsAddressChildDTO
    ...
    _attribute_map = {
        'meter_address': {'key': 'meterAddress', 'type': 'AccountsAddressChildDTO'},
    ...
    def __init__(self, meter_address=None, serial_number=None, meter_id=None, meter_code=None, meter_info=None, meter_type=None, commodity=None, active=None, is_calculated_meter=None, is_split_parent_meter=None, is_split_child_meter=None):
        super(LogicalDeviceMeterChildSearchDTO, self).__init__()
