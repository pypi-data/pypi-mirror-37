...
class EnergyProjectCostSavingsUnitDTO(Model):
    ...
    :param cost_savings_unit_info: The cost savings unit infomation
    ...
    def __init__(self, cost_savings_unit_id=None, cost_savings_unit_code=None, cost_savings_unit_info=None):
        super(EnergyProjectCostSavingsUnitDTO, self).__init__()
