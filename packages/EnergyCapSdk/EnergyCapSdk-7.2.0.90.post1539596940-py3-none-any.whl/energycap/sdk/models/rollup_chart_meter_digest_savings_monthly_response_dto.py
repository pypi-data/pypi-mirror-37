...
class RollupChartMeterDigestSavingsMonthlyResponseDTO(Model):
    ...
    :type meter_info: str
    :param meter_cap:
    :type meter_cap: ~energycap.sdk.models.CostAvoidanceMeterCAPResponseDTO
    ...
    :type results:
     list[~energycap.sdk.models.RollupChartMeterDigestSavingsMonthlyResponseDTOResultsDTO]
    ...
    _attribute_map = {
        ...
        'meter_cap': {'key': 'meterCAP', 'type': 'CostAvoidanceMeterCAPResponseDTO'},
        ...
        'results': {'key': 'results', 'type': '[RollupChartMeterDigestSavingsMonthlyResponseDTOResultsDTO]'},
    ...
    def __init__(self, meter_id=None, meter_code=None, meter_info=None, meter_cap=None, native_use_unit=None, common_use_unit=None, cost_unit=None, results=None, updated=None):
        super(RollupChartMeterDigestSavingsMonthlyResponseDTO, self).__init__()
