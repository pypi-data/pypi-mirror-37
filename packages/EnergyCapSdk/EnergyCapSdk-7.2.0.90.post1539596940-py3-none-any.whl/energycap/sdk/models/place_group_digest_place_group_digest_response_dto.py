...
class PlaceGroupDigestPlaceGroupDigestResponseDTO(Model):
    ...
    :param results:
    :type results:
     list[~energycap.sdk.models.PlaceGroupDigestPlaceGroupDigestChildDTO]
    """
    ...
    _attribute_map = {
        ...
        'results': {'key': 'results', 'type': '[PlaceGroupDigestPlaceGroupDigestChildDTO]'},
    }
    ...
    def __init__(self, place_group_id=None, place_group_code=None, place_group_info=None, place_group_display=None, benchmark_unit=None, benchmark_factor_unit=None, benchmark_value_unit=None, use_unit=None, cost_unit=None, updated=None, results=None):
        super(PlaceGroupDigestPlaceGroupDigestResponseDTO, self).__init__()
