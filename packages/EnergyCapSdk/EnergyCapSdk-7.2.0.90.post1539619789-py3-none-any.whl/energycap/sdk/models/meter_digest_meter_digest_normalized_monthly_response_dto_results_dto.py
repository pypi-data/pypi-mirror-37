...
class MeterDigestMeterDigestNormalizedMonthlyResponseDTOResultsDTO(Model):
    ...
    def __init__(self, period_name=None, calendar_period=None, calendar_year=None, fiscal_period=None, fiscal_year=None, days=None, cumulative_native_use=None, native_use=None, common_use=None, native_actual_demand=None, native_billed_demand=None, load_factor=None):
        super(MeterDigestMeterDigestNormalizedMonthlyResponseDTOResultsDTO, self).__init__()
