...
class CommodityDigestCommodityDigestActualYearlyResponseDTOCommodityDataDTO(Model):
    ...
    :type results:
     list[~energycap.sdk.models.CommodityDigestCommodityDigestActualYearlyResponseDTOCommodityResultsDTO]
    """
    ...
    _attribute_map = {
        ...
        'results': {'key': 'results', 'type': '[CommodityDigestCommodityDigestActualYearlyResponseDTOCommodityResultsDTO]'},
    }
    ...
    def __init__(self, commodity_code=None, commodity_info=None, commodity_id=None, common_use_unit=None, cost_unit=None, results=None):
        super(CommodityDigestCommodityDigestActualYearlyResponseDTOCommodityDataDTO, self).__init__()
