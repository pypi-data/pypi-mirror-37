...
class ImportBillImportRequestDTO(Model):
    ...
    :param batch_settings: If not using Workflow - Batch mode, this property
     ...
     batchCode
    :type batch_settings: ~energycap.sdk.models.ImportBatchSettings
    ...
    _attribute_map = {
        ...
        'batch_settings': {'key': 'batchSettings', 'type': 'ImportBatchSettings'},
    ...
    def __init__(self, file_name, data, profile_code=None, batch_settings=None, import_note=None):
        super(ImportBillImportRequestDTO, self).__init__()
