...
class BillsBillAccountMeterResponseDTO(Model):
    ...
    :type native_use_unit: ~energycap.sdk.models.UnitUnitChildDTO
    :param native_demand: Native demand
    :type native_demand: float
    :param native_demand_unit: The native demand unit of measure
    :type native_demand_unit: ~energycap.sdk.models.UnitUnitChildDTO
    :param native_billed_demand: Native billed demand
    :type native_billed_demand: float
    :param native_billed_demand_unit: The native billed demand unit of measure
    :type native_billed_demand_unit: ~energycap.sdk.models.UnitUnitChildDTO
    :param native_actual_demand: Native actual demand
    :type native_actual_demand: float
    :param native_actual_demand_unit: The native actual demand unit of measure
    :type native_actual_demand_unit: ~energycap.sdk.models.UnitUnitChildDTO
    ...
    :param common_billed_demand_unit: The common billed demand unit of measure
    :type common_billed_demand_unit: ~energycap.sdk.models.UnitUnitChildDTO
    :param common_actual_demand: Common actual demand
    :type common_actual_demand: float
    :param common_actual_demand_unit: The common actual demand unit of measure
    :type common_actual_demand_unit: ~energycap.sdk.models.UnitUnitChildDTO
    ...
    _attribute_map = {
        ...
        'native_use_unit': {'key': 'nativeUseUnit', 'type': 'UnitUnitChildDTO'},
        'native_demand': {'key': 'nativeDemand', 'type': 'float'},
        'native_demand_unit': {'key': 'nativeDemandUnit', 'type': 'UnitUnitChildDTO'},
        'native_billed_demand': {'key': 'nativeBilledDemand', 'type': 'float'},
        'native_billed_demand_unit': {'key': 'nativeBilledDemandUnit', 'type': 'UnitUnitChildDTO'},
        'native_actual_demand': {'key': 'nativeActualDemand', 'type': 'float'},
        'native_actual_demand_unit': {'key': 'nativeActualDemandUnit', 'type': 'UnitUnitChildDTO'},
        ...
        'common_billed_demand_unit': {'key': 'commonBilledDemandUnit', 'type': 'UnitUnitChildDTO'},
        'common_actual_demand': {'key': 'commonActualDemand', 'type': 'float'},
        'common_actual_demand_unit': {'key': 'commonActualDemandUnit', 'type': 'UnitUnitChildDTO'},
