...
class ChargebackNewChargebackWorkflowChargebackWorkflowEditDTO(Model):
    ...
    :type chargeback_workflow_steps:
     list[~energycap.sdk.models.ChargebackNewChargebackWorkflowChargebackWorkflowStepEditDTO]
    """
    ...
    _attribute_map = {
        ...
        'chargeback_workflow_steps': {'key': 'chargebackWorkflowSteps', 'type': '[ChargebackNewChargebackWorkflowChargebackWorkflowStepEditDTO]'},
    }

    def __init__(self, chargeback_workflow_info, chargeback_workflow_steps=None):
        super(ChargebackNewChargebackWorkflowChargebackWorkflowEditDTO, self).__init__()
