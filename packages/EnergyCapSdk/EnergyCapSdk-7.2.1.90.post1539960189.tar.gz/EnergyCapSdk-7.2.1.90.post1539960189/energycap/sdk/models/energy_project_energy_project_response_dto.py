...
class EnergyProjectEnergyProjectResponseDTO(Model):
    ...
    :type energy_savings:
     ~energycap.sdk.models.EnergyProjectEnergySavingsChildDTO
    :param cost_savings: The cost savings
    :type cost_savings: ~energycap.sdk.models.EnergyProjectCostSavingsChildDTO
    :param place: The place of the energy project
    :type place: ~energycap.sdk.models.EnergyProjectPlaceChildDTO
    :param energy_project_type: The project type of the energy project
    :type energy_project_type:
     ~energycap.sdk.models.EnergyProjectEnergyProjectTypeDTO
    """
    ...
    _attribute_map = {
        ...
        'energy_savings': {'key': 'energySavings', 'type': 'EnergyProjectEnergySavingsChildDTO'},
        'cost_savings': {'key': 'costSavings', 'type': 'EnergyProjectCostSavingsChildDTO'},
        'place': {'key': 'place', 'type': 'EnergyProjectPlaceChildDTO'},
        'energy_project_type': {'key': 'energyProjectType', 'type': 'EnergyProjectEnergyProjectTypeDTO'},
    }
    ...
    def __init__(self, energy_project_code, energy_project_info, energy_project_id=None, installation_begin_date=None, installation_end_date=None, installation_cost=None, utility_rebate=None, funding_source=None, project_manager=None, note=None, energy_savings=None, cost_savings=None, place=None, energy_project_type=None):
        super(EnergyProjectEnergyProjectResponseDTO, self).__init__()
