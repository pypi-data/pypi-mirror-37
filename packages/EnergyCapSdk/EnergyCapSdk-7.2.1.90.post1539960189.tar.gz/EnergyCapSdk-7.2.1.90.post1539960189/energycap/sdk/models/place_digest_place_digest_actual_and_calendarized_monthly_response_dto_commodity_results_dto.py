...
class PlaceDigestPlaceDigestActualAndCalendarizedMonthlyResponseDTOCommodityResultsDTO(Model):
    ...
    def __init__(self, period_name=None, calendar_period=None, calendar_year=None, fiscal_period=None, fiscal_year=None, total_cost=None, common_use=None, common_use_unit_cost=None, global_use=None, global_use_unit_cost=None, common_demand=None, common_demand_unit_cost=None):
        super(PlaceDigestPlaceDigestActualAndCalendarizedMonthlyResponseDTOCommodityResultsDTO, self).__init__()
