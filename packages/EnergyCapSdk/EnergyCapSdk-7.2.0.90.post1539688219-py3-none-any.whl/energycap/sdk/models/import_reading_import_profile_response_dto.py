...
class ImportReadingImportProfileResponseDTO(Model):
    """ImportReadingImportProfileResponseDTO.

    :param profile_id: The profile Indentifier
    :type profile_id: int
    :param profile_code: The profile code
    :type profile_code: str
    :param created_by: The user the profile was created by
    ...
    :param delimiter: The string that represents how the file contents are
     delimeted.  Valid options are "\\t" for tab, " " for space and "," for
     comma.
    :type delimiter: str
    ...
    :param time_zone: The time zone for the readings
    :type time_zone: ~energycap.sdk.models.TimeZoneTimeZoneChildDTO
    ...
    :param estimated: Column number and indicator to mark imported readings as
     estimated
    :type estimated: ~energycap.sdk.models.ImportEstimatedDTO
    ...
    _attribute_map = {
        ...
        'time_zone': {'key': 'timeZone', 'type': 'TimeZoneTimeZoneChildDTO'},
        'data_mapping': {'key': 'dataMapping', 'type': '[ImportReadingImportProfileColumn]'},
        'estimated': {'key': 'estimated', 'type': 'ImportEstimatedDTO'},
    ...
    def __init__(self, profile_id=None, profile_code=None, created_by=None, meter_import_id_column_number=None, channel_import_id_column_number=None, number_of_columns=None, channel_interval_in_seconds=None, delimiter=None, number_of_header_rows=None, timestamp_column_number=None, timestamp_format=None, date_column_number=None, time_column_number=None, date_format=None, time_format=None, time_zone=None, data_mapping=None, estimated=None, note_column_number=None):
        super(ImportReadingImportProfileResponseDTO, self).__init__()
