...
class ChargebackNewCalculatedBillCopyFromMeterResponseDTO(Model):
    """Defines an account and meter whose use or cost will be copied when
    calculating a bill.

    :param meter: Meter from which use or cost will be copied
    ...
    def __init__(self, meter=None, percentage=None):
        super(ChargebackNewCalculatedBillCopyFromMeterResponseDTO, self).__init__()
        self.meter = meter
