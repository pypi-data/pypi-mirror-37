...
class AccountDigestAccountDigestActualMonthlyResponseDTOCommodityDataDTO(Model):
    ...
    :type results:
     list[~energycap.sdk.models.AccountDigestAccountDigestActualMonthlyResponseDTOCommodityResultsDTO]
    """
    ...
    _attribute_map = {
        ...
        'results': {'key': 'results', 'type': '[AccountDigestAccountDigestActualMonthlyResponseDTOCommodityResultsDTO]'},
    }
    ...
    def __init__(self, commodity_code=None, commodity_info=None, commodity_id=None, common_use_unit=None, cost_unit=None, results=None):
        super(AccountDigestAccountDigestActualMonthlyResponseDTOCommodityDataDTO, self).__init__()
