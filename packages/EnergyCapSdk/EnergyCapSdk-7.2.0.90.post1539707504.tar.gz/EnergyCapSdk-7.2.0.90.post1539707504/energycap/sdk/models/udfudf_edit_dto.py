...
class UDFUDFEditDTO(Model):
    ...
    :type udf_select_values:
     list[~energycap.sdk.models.UDFUDFSelectValueEditDTO]
    """
    ...
    _attribute_map = {
        ...
        'udf_select_values': {'key': 'udfSelectValues', 'type': '[UDFUDFSelectValueEditDTO]'},
    }

    def __init__(self, name, display_order, udf_select_values=None):
        super(UDFUDFEditDTO, self).__init__()
        self.name = name
