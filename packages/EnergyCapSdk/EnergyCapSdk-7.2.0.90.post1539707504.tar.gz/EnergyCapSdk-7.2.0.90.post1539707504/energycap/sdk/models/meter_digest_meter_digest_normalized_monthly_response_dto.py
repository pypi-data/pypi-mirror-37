...
class MeterDigestMeterDigestNormalizedMonthlyResponseDTO(Model):
    ...
    :type results:
     list[~energycap.sdk.models.MeterDigestMeterDigestNormalizedMonthlyResponseDTOResultsDTO]
    """
    ...
    _attribute_map = {
        ...
        'results': {'key': 'results', 'type': '[MeterDigestMeterDigestNormalizedMonthlyResponseDTOResultsDTO]'},
    }
    ...
    def __init__(self, meter_code=None, meter_info=None, meter_id=None, updated=None, native_use_unit=None, native_demand_unit=None, common_use_unit=None, results=None):
        super(MeterDigestMeterDigestNormalizedMonthlyResponseDTO, self).__init__()
