...
class HierarchicalPlaces2Dto(Model):
    ...
    :type place_children: list[~energycap.sdk.models.HierarchicalPlacesDto]
    """
    ...
    _attribute_map = {
        ...
        'place_children': {'key': 'placeChildren', 'type': '[HierarchicalPlacesDto]'},
    }
    ...
    def __init__(self, parent_id=None, place_id=None, place_info=None, place_code=None, place_type_id=None, has_children=None, meter_children=None, place_children=None):
        super(HierarchicalPlaces2Dto, self).__init__()
