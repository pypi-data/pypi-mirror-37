...
class PlaceDigestPlaceDigestSavingsYearlyResponseDTOCommodityDataDTO(Model):
    ...
    :type results:
     list[~energycap.sdk.models.PlaceDigestPlaceDigestSavingsYearlyResponseDTOCommodityDataDTOCommodityResultsDTO]
    """
    ...
    _attribute_map = {
        ...
        'results': {'key': 'results', 'type': '[PlaceDigestPlaceDigestSavingsYearlyResponseDTOCommodityDataDTOCommodityResultsDTO]'},
    }
    ...
    def __init__(self, commodity_code=None, commodity_info=None, commodity_id=None, all_time_batcc_common_use=None, all_time_common_use=None, all_time_savings_common_use=None, all_time_batcc_global_use=None, all_time_global_use=None, all_time_savings_global_use=None, all_time_batcc_total_cost=None, all_time_total_cost=None, all_time_savings_total_cost=None, cost_unit=None, common_use_unit=None, results=None):
        super(PlaceDigestPlaceDigestSavingsYearlyResponseDTOCommodityDataDTO, self).__init__()
