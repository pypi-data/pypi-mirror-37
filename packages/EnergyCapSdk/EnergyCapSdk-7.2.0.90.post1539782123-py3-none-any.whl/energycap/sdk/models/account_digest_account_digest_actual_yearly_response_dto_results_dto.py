...
class AccountDigestAccountDigestActualYearlyResponseDTOResultsDTO(Model):
    ...
    def __init__(self, year=None, total_cost=None, global_use=None, global_use_unit_cost=None):
        super(AccountDigestAccountDigestActualYearlyResponseDTOResultsDTO, self).__init__()
        self.year = year
