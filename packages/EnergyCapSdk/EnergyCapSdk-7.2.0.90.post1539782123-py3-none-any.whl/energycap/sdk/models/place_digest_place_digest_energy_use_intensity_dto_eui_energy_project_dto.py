...
class PlaceDigestPlaceDigestEnergyUseIntensityDTOEuiEnergyProjectDTO(Model):
    ...
    def __init__(self, energy_project_id=None, energy_project_code=None, energy_project_info=None, installation_cost=None):
        super(PlaceDigestPlaceDigestEnergyUseIntensityDTOEuiEnergyProjectDTO, self).__init__()
