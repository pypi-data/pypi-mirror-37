...
class SavingsSavingsDailyDataDTO(Model):
    ...
    :type messages: list[~energycap.sdk.models.SavingsMessageDTO]
    ...
    _attribute_map = {
        ...
        'messages': {'key': 'messages', 'type': '[SavingsMessageDTO]'},
    ...
    def __init__(self, batcc_non_weather_native_use=None, batcc_weather_native_use=None, baseline_non_weather_native_use=None, baseline_weather_native_use=None, batcc_cost=None, average_unit_cost=None, baseline_cooling_degree_days=None, current_cooling_degree_days=None, baseline_heating_degree_days=None, current_heating_degree_days=None, special_adjustment=None, area_adjustment=None, weather_adjustment=None, other_adjustment=None, date_property=None, messages=None, cost_unit=None):
        super(SavingsSavingsDailyDataDTO, self).__init__()
