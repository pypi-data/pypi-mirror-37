...
class ChannelChannelResponseDTO(Model):
    ...
    :param meter: The meter to which the channel belongs
    :type meter: ~energycap.sdk.models.LogicalDeviceMeterChildDTO
    :param commodity: The commodity of the channel
    :type commodity: ~energycap.sdk.models.CommoditiesCommodityChildDTO
    :param observation_type: The observation type of the channel
    :type observation_type:
     ~energycap.sdk.models.LogicalDeviceObservationTypeChildDTO
    :param observation_method: The channel's observation method. Possible
     values include "Automatic", "Manual", "Estimated", "Simulated", "Accrual"
     and "Adjustment"
    :type observation_method:
     ~energycap.sdk.models.LogicalDeviceObservationMethodDTO
    :param observation_rule: The channel's observation rule. Possible values
     include "Odometer" and "Trip"
    :type observation_rule:
     ~energycap.sdk.models.LogicalDeviceObservationRuleDTO
    :param unit: The channel's unit of measure
    ...
    :type properties: ~energycap.sdk.models.LogicalDeviceDeviceChannelChildDTO
    ...
    _attribute_map = {
        ...
        'observation_method': {'key': 'observationMethod', 'type': 'LogicalDeviceObservationMethodDTO'},
        'observation_rule': {'key': 'observationRule', 'type': 'LogicalDeviceObservationRuleDTO'},
        ...
        'properties': {'key': 'properties', 'type': 'LogicalDeviceDeviceChannelChildDTO'},
    ...
    def __init__(self, channel_id=None, channel_code=None, meter=None, commodity=None, observation_type=None, observation_method=None, observation_rule=None, unit=None, interval_minutes=None, hidden=None, total_sum=None, properties=None, has_readings=None, is_used_on_distribution=None, last_reading_date=None, first_reading_date=None, auto_summarize=None, channel_import_id=None, maximum_reading=None, multiplier=None):
        super(ChannelChannelResponseDTO, self).__init__()
