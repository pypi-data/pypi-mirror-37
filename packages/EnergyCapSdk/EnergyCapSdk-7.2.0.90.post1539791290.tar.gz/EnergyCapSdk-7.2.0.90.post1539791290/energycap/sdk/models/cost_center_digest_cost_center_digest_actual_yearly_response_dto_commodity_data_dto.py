...
class CostCenterDigestCostCenterDigestActualYearlyResponseDTOCommodityDataDTO(Model):
    ...
    :type results:
     list[~energycap.sdk.models.CostCenterDigestCostCenterDigestActualYearlyResponseDTOCommodityResultsDTO]
    """
    ...
    _attribute_map = {
        ...
        'results': {'key': 'results', 'type': '[CostCenterDigestCostCenterDigestActualYearlyResponseDTOCommodityResultsDTO]'},
    }
    ...
    def __init__(self, commodity_code=None, commodity_info=None, commodity_id=None, common_use_unit=None, cost_unit=None, results=None):
        super(CostCenterDigestCostCenterDigestActualYearlyResponseDTOCommodityDataDTO, self).__init__()
