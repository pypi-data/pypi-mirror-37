...
class PlaceEnergyStarPlacePropertyResponseDTO(Model):
    ...
    :type datatype: ~energycap.sdk.models.UnitDataTypeResponseDTO
    ...
    _attribute_map = {
        ...
        'datatype': {'key': 'datatype', 'type': 'UnitDataTypeResponseDTO'},
    ...
    def __init__(self, energy_star_property_id=None, property_id=None, effective_date=None, value=None, place_type_code=None, place_type_info=None, datatype=None, caption=None, default_value=None, min_value=None, max_value=None, required=None):
        super(PlaceEnergyStarPlacePropertyResponseDTO, self).__init__()
