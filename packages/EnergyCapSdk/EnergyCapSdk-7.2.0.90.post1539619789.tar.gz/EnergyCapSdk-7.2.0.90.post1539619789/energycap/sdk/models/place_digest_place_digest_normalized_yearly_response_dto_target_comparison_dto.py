...
class PlaceDigestPlaceDigestNormalizedYearlyResponseDTOTargetComparisonDTO(Model):
    ...
    def __init__(self, target_year=None, target_label=None, global_use=None, global_use_ytd=None):
        super(PlaceDigestPlaceDigestNormalizedYearlyResponseDTOTargetComparisonDTO, self).__init__()
