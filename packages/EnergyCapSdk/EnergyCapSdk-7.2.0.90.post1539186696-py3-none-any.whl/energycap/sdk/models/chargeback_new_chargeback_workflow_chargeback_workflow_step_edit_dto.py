...
class ChargebackNewChargebackWorkflowChargebackWorkflowStepEditDTO(Model):
    ...
    :param chargeback_workflow_step_id: Identifier for the chargeback workflow
     ...
     If calculateBillWorkflowStepId is null, a new step will be created
    ...
    def __init__(self, chargeback_workflow_step_info, chargeback_workflow_step_description, chargeback_workflow_step_id=None, chargeback_workflow_step_type=None):
        super(ChargebackNewChargebackWorkflowChargebackWorkflowStepEditDTO, self).__init__()
