...
class BillsBillCreateDTO(Model):
    """BillsBillCreateDTO.
    ...
    :type meters: list[~energycap.sdk.models.BillsBillMeterCreateDTO]
    :param account_body_lines: The account line items
    :type account_body_lines:
     list[~energycap.sdk.models.BillsBillAccountBodyLineCreateDTO]
    """
    ...
    _attribute_map = {
        ...
        'meters': {'key': 'meters', 'type': '[BillsBillMeterCreateDTO]'},
        'account_body_lines': {'key': 'accountBodyLines', 'type': '[BillsBillAccountBodyLineCreateDTO]'},
    }
    ...
    def __init__(self, account_id, begin_date, end_date, billing_period, manual_entry, account_period=None, estimated=None, statement_date=None, due_date=None, next_reading=None, control_code=None, invoice_number=None, note=None, meters=None, account_body_lines=None):
        super(BillsBillCreateDTO, self).__init__()
