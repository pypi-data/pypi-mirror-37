...
class LogicalDeviceMeterCreateDTO(Model):
    ...
    def __init__(self, meter_code, meter_info, commodity_id, place_id, meter_type_id, address=None, bill_entry_note=None, include_in_energy_star=None, properties=None, primary_use_id=None, meter_time_zone_id=None):
        super(LogicalDeviceMeterCreateDTO, self).__init__()
