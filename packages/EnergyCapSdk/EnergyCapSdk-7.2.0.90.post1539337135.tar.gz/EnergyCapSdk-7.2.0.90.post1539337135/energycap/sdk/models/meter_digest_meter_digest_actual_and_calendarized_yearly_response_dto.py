...
class MeterDigestMeterDigestActualAndCalendarizedYearlyResponseDTO(Model):
    ...
    :type results:
     list[~energycap.sdk.models.MeterDigestMeterDigestActualAndCalendarizedYearlyResponseDTOResultsDTO]
    """
    ...
    _attribute_map = {
        ...
        'results': {'key': 'results', 'type': '[MeterDigestMeterDigestActualAndCalendarizedYearlyResponseDTOResultsDTO]'},
    }
    ...
    def __init__(self, meter_code=None, meter_info=None, meter_id=None, native_use_unit=None, native_demand_unit=None, common_use_unit=None, cost_unit=None, updated=None, results=None):
        super(MeterDigestMeterDigestActualAndCalendarizedYearlyResponseDTO, self).__init__()
