...
class GroupPlaceGroupResponseDTO(Model):
    ...
    :param place_group_category: The type of this place group
    :type place_group_category:
     ~energycap.sdk.models.GroupPlaceGroupCategoryChildDTO
    ...
    :type user_defined_auto_group_filters:
     list[~energycap.sdk.models.CommonFilterResponse]
    ...
    _attribute_map = {
        ...
        'place_group_category': {'key': 'placeGroupCategory', 'type': 'GroupPlaceGroupCategoryChildDTO'},
        'limit_members_by_topmost': {'key': 'limitMembersByTopmost', 'type': 'bool'},
        'user_defined_auto_group': {'key': 'userDefinedAutoGroup', 'type': 'bool'},
        'user_defined_auto_group_filters': {'key': 'userDefinedAutoGroupFilters', 'type': '[CommonFilterResponse]'},
    ...
    def __init__(self, place_group_id=None, place_group_code=None, place_group_info=None, auto_group=None, member_count=None, member_count_with_topmost=None, place_group_category=None, limit_members_by_topmost=None, user_defined_auto_group=None, user_defined_auto_group_filters=None, last_updated=None):
        super(GroupPlaceGroupResponseDTO, self).__init__()
