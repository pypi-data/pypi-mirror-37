...
class MeterDigestMeterDigestActualAndCalendarizedYearlyResponseDTOResultsDTO(Model):
    ...
    def __init__(self, year=None, total_cost=None, native_use=None, native_use_unit_cost=None, common_use=None, common_use_unit_cost=None, native_demand=None, native_demand_unit_cost=None):
        super(MeterDigestMeterDigestActualAndCalendarizedYearlyResponseDTOResultsDTO, self).__init__()
        self.year = year
