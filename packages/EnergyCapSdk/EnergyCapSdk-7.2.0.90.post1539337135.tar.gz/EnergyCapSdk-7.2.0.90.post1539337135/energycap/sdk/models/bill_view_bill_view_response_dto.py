...
class BillViewBillViewResponseDTO(Model):
    ...
    :type ap_exported_by: ~energycap.sdk.models.UserUserChildDTO
    ...
    :type account: ~energycap.sdk.models.BillViewAccountChildDTO
    ...
    :type bill_history:
     list[~energycap.sdk.models.BillsBillHistoryResponseDTO]
    :param meters: The list of meters on the bill
    :type meters: list[~energycap.sdk.models.BillViewMeterChildDTO]
    :param body_lines: The list of body lines on the bill
    :type body_lines: list[~energycap.sdk.models.BillViewBodylineChildDTO]
    :param bill_account_meters: The list of account-meter summaries on the
     bill
    :type bill_account_meters:
     list[~energycap.sdk.models.BillsBillAccountMeterChildDTO]
    :param calendarized_history: Calendarized history informtion for the
     account
    :type calendarized_history:
     list[~energycap.sdk.models.BillViewBillCalendarizedHistoryDTO]
    """
    ...
    _attribute_map = {
        ...
        'ap_exported_by': {'key': 'apExportedBy', 'type': 'UserUserChildDTO'},
        ...
        'account': {'key': 'account', 'type': 'BillViewAccountChildDTO'},
        ...
        'bill_history': {'key': 'billHistory', 'type': '[BillsBillHistoryResponseDTO]'},
        'meters': {'key': 'meters', 'type': '[BillViewMeterChildDTO]'},
        'body_lines': {'key': 'bodyLines', 'type': '[BillViewBodylineChildDTO]'},
        'bill_account_meters': {'key': 'billAccountMeters', 'type': '[BillsBillAccountMeterChildDTO]'},
        'calendarized_history': {'key': 'calendarizedHistory', 'type': '[BillViewBillCalendarizedHistoryDTO]'},
    }
    ...
    def __init__(self, bill_id=None, void=None, from_vendor=None, creation_method=None, accrual=None, accrual_reversed=None, batch=None, batch_end_date=None, hide_batch_code=None, created_by=None, created_date=None, modified_by=None, modified_date=None, approved=None, approve_date=None, approved_by=None, has_been_split=None, was_split_date=None, export_hold=None, ap_exported=None, ap_export_date=None, ap_exported_by=None, gl_exported=None, gl_exported_by=None, gl_export_date=None, check_number=None, check_date=None, pay_status=None, cleared_date=None, account=None, begin_date=None, end_date=None, billing_period=None, days=None, account_period=None, account_period_name=None, hide_account_period=None, hide_account_year=None, total_cost=None, balance=None, estimated=None, hide_estimated=None, statement_date=None, hide_statement_date=None, due_date=None, hide_due_date=None, invoice_number=None, hide_invoice_number=None, control_code=None, hide_control_code=None, bill_image_url=None, bill_note=None, next_reading=None, hide_next_reading=None, prior_bill_id=None, next_bill_id=None, bill_history=None, meters=None, body_lines=None, bill_account_meters=None, calendarized_history=None):
        super(BillViewBillViewResponseDTO, self).__init__()
