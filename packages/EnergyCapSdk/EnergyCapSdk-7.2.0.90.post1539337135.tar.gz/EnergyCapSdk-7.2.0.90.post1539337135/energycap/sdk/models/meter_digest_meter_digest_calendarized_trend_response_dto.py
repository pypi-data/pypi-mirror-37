...
class MeterDigestMeterDigestCalendarizedTrendResponseDTO(Model):
    ...
    :type results:
     list[~energycap.sdk.models.MeterDigestMeterDigestCalendarizedTrendResponseDTOResultsDTO]
    """
    ...
    _attribute_map = {
        ...
        'results': {'key': 'results', 'type': '[MeterDigestMeterDigestCalendarizedTrendResponseDTOResultsDTO]'},
    }
    ...
    def __init__(self, meter_code=None, meter_info=None, meter_id=None, updated=None, native_use_unit=None, native_demand_unit=None, common_use_unit=None, cost_unit=None, results=None):
        super(MeterDigestMeterDigestCalendarizedTrendResponseDTO, self).__init__()
