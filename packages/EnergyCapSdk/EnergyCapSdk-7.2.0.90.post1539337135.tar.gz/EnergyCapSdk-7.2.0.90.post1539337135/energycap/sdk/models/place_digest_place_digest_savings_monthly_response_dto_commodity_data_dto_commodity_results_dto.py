...
class PlaceDigestPlaceDigestSavingsMonthlyResponseDTOCommodityDataDTOCommodityResultsDTO(Model):
    """PlaceDigestPlaceDigestSavingsMonthlyResponseDTOCommodityDataDTOCommodityResultsDTO.

    :param period_name:
    :type period_name: str
    :param calendar_period:
    ...
    def __init__(self, period_name=None, calendar_period=None, calendar_year=None, fiscal_period=None, fiscal_year=None, savings_total_cost=None, savings_common_use=None, savings_global_use=None):
        super(PlaceDigestPlaceDigestSavingsMonthlyResponseDTOCommodityDataDTOCommodityResultsDTO, self).__init__()
