...
class ChargebackNewChargebackProcessorChargebackProcessorSettingsDTO(Model):
    ...
    :type batch_settings: ~energycap.sdk.models.BatchBatchCreateDto
    ...
    _attribute_map = {
        ...
        'batch_settings': {'key': 'batchSettings', 'type': 'BatchBatchCreateDto'},
    ...
    def __init__(self, billing_period, filters=None, batch_settings=None, start_date_for_bill=None, end_date_for_bill=None, note=None):
        super(ChargebackNewChargebackProcessorChargebackProcessorSettingsDTO, self).__init__()
