...
class AccountsAccountCreateDTO(Model):
    ...
    _validation = {
        ...
        'postal_code': {'required': True, 'max_length': 10, 'min_length': 0},
    ...
    def __init__(self, account_code, account_info, account_type_id, cost_center_id, vendor_id, postal_code, country, customer_id=None, contact_id=None, active=None, accrual_enabled=None, city=None, state=None, line1=None, line2=None, deposit_paid=None, deposit_return=None, deposit_note=None, deposit_amount=None, memo=None, service_start=None, service_end=None, meters=None, general_ledger_id=None):
        super(AccountsAccountCreateDTO, self).__init__()
