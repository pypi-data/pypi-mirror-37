...
class CommodityDigestCommodityDigestActualYearlyResponseDTOResultsDTO(Model):
    ...
    def __init__(self, year=None, total_cost=None, global_use=None, global_use_unit_cost=None):
        super(CommodityDigestCommodityDigestActualYearlyResponseDTOResultsDTO, self).__init__()
        self.year = year
