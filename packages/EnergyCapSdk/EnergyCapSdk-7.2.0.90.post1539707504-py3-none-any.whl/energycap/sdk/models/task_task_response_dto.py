...
class TaskTaskResponseDTO(Model):
    """TaskTaskResponseDTO.
    ...
    :type task_type: ~energycap.sdk.models.TaskTaskTypeDto
    ...
    _attribute_map = {
        ...
        'task_type': {'key': 'taskType', 'type': 'TaskTaskTypeDto'},
    ...
    def __init__(self, has_attachments=None, task_id=None, task_gu_id=None, task_type=None, begin_date=None, end_date=None, user=None, message=None, output=None, settings=None, status=None, task_note=None):
        super(TaskTaskResponseDTO, self).__init__()
