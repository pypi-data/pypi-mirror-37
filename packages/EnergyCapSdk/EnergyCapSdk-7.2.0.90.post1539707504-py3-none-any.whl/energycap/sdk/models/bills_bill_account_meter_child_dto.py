...
class BillsBillAccountMeterChildDTO(Model):
    ...
    :param native_use_unit: The bill-account-meter's native use unit
    ...
    :param direct_cost_unit: The bill-account-meter's direct cost unit
    :type direct_cost_unit: ~energycap.sdk.models.UnitUnitChildDTO
    ...
    :param native_billed_demand_unit: The bill-account-meter's native billed
     demand unit
    ...
    :param native_actual_demand_unit: The bill-account-meter's native actual
     demand unit
    ...
    _attribute_map = {
        ...
        'direct_cost_unit': {'key': 'directCostUnit', 'type': 'UnitUnitChildDTO'},
    ...
    def __init__(self, account_id=None, meter_id=None, native_use=None, native_use_unit=None, direct_cost=None, direct_cost_unit=None, native_use_unit_cost=None, native_use_per_day=None, direct_cost_per_day=None, native_billed_demand=None, native_billed_demand_unit=None, native_actual_demand=None, native_actual_demand_unit=None):
        super(BillsBillAccountMeterChildDTO, self).__init__()
