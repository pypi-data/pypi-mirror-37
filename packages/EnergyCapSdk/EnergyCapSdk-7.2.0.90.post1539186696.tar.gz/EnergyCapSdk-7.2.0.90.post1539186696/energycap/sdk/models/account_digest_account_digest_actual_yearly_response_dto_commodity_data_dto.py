...
class AccountDigestAccountDigestActualYearlyResponseDTOCommodityDataDTO(Model):
    ...
    :type results:
     list[~energycap.sdk.models.AccountDigestAccountDigestActualYearlyResponseDTOCommodityResultsDTO]
    """
    ...
    _attribute_map = {
        ...
        'results': {'key': 'results', 'type': '[AccountDigestAccountDigestActualYearlyResponseDTOCommodityResultsDTO]'},
    }
    ...
    def __init__(self, commodity_code=None, commodity_info=None, commodity_id=None, common_use_unit=None, cost_unit=None, results=None):
        super(AccountDigestAccountDigestActualYearlyResponseDTOCommodityDataDTO, self).__init__()
