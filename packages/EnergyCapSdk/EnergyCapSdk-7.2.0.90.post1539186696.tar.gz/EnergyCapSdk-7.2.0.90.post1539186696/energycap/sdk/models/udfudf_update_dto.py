...
class UDFUDFUpdateDTO(Model):
    ...
    :type udf_select_values:
     list[~energycap.sdk.models.UDFUDFSelectValueUpdateDTO]
    """
    ...
    _attribute_map = {
        ...
        'udf_select_values': {'key': 'udfSelectValues', 'type': '[UDFUDFSelectValueUpdateDTO]'},
    }

    def __init__(self, udf_id, name, data_type_id, udf_select_values=None):
        super(UDFUDFUpdateDTO, self).__init__()
        self.udf_id = udf_id
        self.name = name
