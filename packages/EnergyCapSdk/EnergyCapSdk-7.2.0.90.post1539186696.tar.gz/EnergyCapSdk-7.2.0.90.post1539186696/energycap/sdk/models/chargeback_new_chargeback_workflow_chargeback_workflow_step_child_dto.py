...
class ChargebackNewChargebackWorkflowChargebackWorkflowStepChildDTO(Model):
    ...
    :param chargeback_workflow: Workflow this step is assigned to
    :type chargeback_workflow:
     ~energycap.sdk.models.ChargebackNewChargebackWorkflowChargebackWorkflowBaseDTO
    """
    ...
    _attribute_map = {
        ...
        'chargeback_workflow': {'key': 'chargebackWorkflow', 'type': 'ChargebackNewChargebackWorkflowChargebackWorkflowBaseDTO'},
    }
    ...
    def __init__(self, chargeback_workflow_step_id=None, chargeback_workflow_step_info=None, chargeback_workflow_step_description=None, chargeback_workflow_step_type=None, chargeback_workflow_step_order=None, chargeback_workflow=None):
        super(ChargebackNewChargebackWorkflowChargebackWorkflowStepChildDTO, self).__init__()
