...
class AccountDigestAccountDigestActualYearlyResponseDTOCommodityResultsDTO(Model):
    ...
    def __init__(self, year=None, total_cost=None, common_use=None, common_use_unit_cost=None, global_use=None, global_use_unit_cost=None):
        super(AccountDigestAccountDigestActualYearlyResponseDTOCommodityResultsDTO, self).__init__()
        self.year = year
