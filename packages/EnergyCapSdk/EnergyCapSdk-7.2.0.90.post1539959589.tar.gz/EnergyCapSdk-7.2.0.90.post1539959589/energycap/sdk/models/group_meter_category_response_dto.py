...
class GroupMeterCategoryResponseDTO(Model):
    ...
    def __init__(self, meter_group_category_id=None, meter_group_category_code=None, meter_group_category_info=None, auto_group=None, number_of_groups=None):
        super(GroupMeterCategoryResponseDTO, self).__init__()
