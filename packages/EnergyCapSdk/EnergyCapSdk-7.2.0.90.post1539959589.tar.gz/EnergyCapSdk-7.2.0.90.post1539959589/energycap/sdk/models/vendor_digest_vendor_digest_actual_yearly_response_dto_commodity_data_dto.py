...
class VendorDigestVendorDigestActualYearlyResponseDTOCommodityDataDTO(Model):
    ...
    :type results:
     list[~energycap.sdk.models.VendorDigestVendorDigestActualYearlyResponseDTOCommodityResultsDTO]
    """
    ...
    _attribute_map = {
        ...
        'results': {'key': 'results', 'type': '[VendorDigestVendorDigestActualYearlyResponseDTOCommodityResultsDTO]'},
    }
    ...
    def __init__(self, commodity_code=None, commodity_info=None, commodity_id=None, common_use_unit=None, cost_unit=None, results=None):
        super(VendorDigestVendorDigestActualYearlyResponseDTOCommodityDataDTO, self).__init__()
