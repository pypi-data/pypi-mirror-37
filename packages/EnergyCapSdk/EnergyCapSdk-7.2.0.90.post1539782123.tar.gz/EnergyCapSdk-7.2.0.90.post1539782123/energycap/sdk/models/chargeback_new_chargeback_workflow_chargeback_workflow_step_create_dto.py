...
class ChargebackNewChargebackWorkflowChargebackWorkflowStepCreateDTO(Model):
    ...
    def __init__(self, chargeback_workflow_step_info, chargeback_workflow_step_description, chargeback_workflow_step_type=None):
        super(ChargebackNewChargebackWorkflowChargebackWorkflowStepCreateDTO, self).__init__()
