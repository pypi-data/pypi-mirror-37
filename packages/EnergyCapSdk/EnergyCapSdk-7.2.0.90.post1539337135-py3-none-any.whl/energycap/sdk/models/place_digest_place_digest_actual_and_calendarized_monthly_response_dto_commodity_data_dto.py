...
class PlaceDigestPlaceDigestActualAndCalendarizedMonthlyResponseDTOCommodityDataDTO(Model):
    ...
    :type results:
     list[~energycap.sdk.models.PlaceDigestPlaceDigestActualAndCalendarizedMonthlyResponseDTOCommodityResultsDTO]
    ...
    _attribute_map = {
        ...
        'results': {'key': 'results', 'type': '[PlaceDigestPlaceDigestActualAndCalendarizedMonthlyResponseDTOCommodityResultsDTO]'},
    ...
    def __init__(self, commodity_code=None, commodity_info=None, commodity_id=None, common_use_unit=None, common_demand_unit=None, cost_unit=None, results=None, target_comparison=None):
        super(PlaceDigestPlaceDigestActualAndCalendarizedMonthlyResponseDTOCommodityDataDTO, self).__init__()
