...
class SearchSearchAccountMeterBillEntryDTO(Model):
    ...
    :type account_address: ~energycap.sdk.models.AccountsAddressChildDTO
    :param meters: The Account's vendor
    :type meters: list[~energycap.sdk.models.LogicalDeviceMeterChildSearchDTO]
    """
    ...
    _attribute_map = {
        ...
        'account_address': {'key': 'accountAddress', 'type': 'AccountsAddressChildDTO'},
        'meters': {'key': 'meters', 'type': '[LogicalDeviceMeterChildSearchDTO]'},
    }
    ...
    def __init__(self, match_type=None, account_id=None, account_code=None, account_info=None, previous_account_code=None, active=None, account_type=None, has_calculated_meter=None, has_split_parent_meter=None, has_split_child_meter=None, vendor=None, account_address=None, meters=None):
        super(SearchSearchAccountMeterBillEntryDTO, self).__init__()
