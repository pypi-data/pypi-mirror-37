...
class MeterGroupDigestMeterGroupDigestResponseDTO(Model):
    ...
    :param results:
    :type results:
     list[~energycap.sdk.models.MeterGroupDigestMeterGroupDigestChildDTO]
    """
    ...
    _attribute_map = {
        ...
        'results': {'key': 'results', 'type': '[MeterGroupDigestMeterGroupDigestChildDTO]'},
    }
    ...
    def __init__(self, meter_group_id=None, meter_group_code=None, meter_group_info=None, meter_group_display=None, updated=None, results=None):
        super(MeterGroupDigestMeterGroupDigestResponseDTO, self).__init__()
