...
class RateDigestRateDigestActualYearlyResponseDTOCommodityDataDTO(Model):
    ...
    :type results:
     list[~energycap.sdk.models.RateDigestRateDigestActualYearlyResponseDTOCommodityResultsDTO]
    """
    ...
    _attribute_map = {
        ...
        'results': {'key': 'results', 'type': '[RateDigestRateDigestActualYearlyResponseDTOCommodityResultsDTO]'},
    }
    ...
    def __init__(self, commodity_code=None, commodity_info=None, commodity_id=None, common_use_unit=None, cost_unit=None, results=None):
        super(RateDigestRateDigestActualYearlyResponseDTOCommodityDataDTO, self).__init__()
