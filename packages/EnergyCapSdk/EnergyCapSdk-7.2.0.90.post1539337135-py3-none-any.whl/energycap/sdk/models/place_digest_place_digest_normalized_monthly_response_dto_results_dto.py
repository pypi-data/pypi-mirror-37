...
class PlaceDigestPlaceDigestNormalizedMonthlyResponseDTOResultsDTO(Model):
    ...
    def __init__(self, period_name=None, calendar_period=None, calendar_year=None, fiscal_period=None, fiscal_year=None, global_use=None):
        super(PlaceDigestPlaceDigestNormalizedMonthlyResponseDTOResultsDTO, self).__init__()
