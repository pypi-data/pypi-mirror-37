...
class MeterDigestMeterDigestActualAndCalendarizedMonthlyResponseDTO(Model):
    ...
    :type results:
     list[~energycap.sdk.models.MeterDigestMeterDigestActualAndCalendarizedMonthlyResponseDTOResultsDTO]
    """
    ...
    _attribute_map = {
        ...
        'results': {'key': 'results', 'type': '[MeterDigestMeterDigestActualAndCalendarizedMonthlyResponseDTOResultsDTO]'},
    }
    ...
    def __init__(self, meter_code=None, meter_info=None, meter_id=None, updated=None, native_use_unit=None, native_demand_unit=None, common_use_unit=None, cost_unit=None, results=None):
        super(MeterDigestMeterDigestActualAndCalendarizedMonthlyResponseDTO, self).__init__()
