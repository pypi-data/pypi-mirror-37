...
class VendorDigestVendorDigestActualYearlyResponseDTOCommodityResultsDTO(Model):
    ...
    def __init__(self, year=None, total_cost=None, common_use=None, common_use_unit_cost=None, global_use=None, global_use_unit_cost=None):
        super(VendorDigestVendorDigestActualYearlyResponseDTOCommodityResultsDTO, self).__init__()
        self.year = year
