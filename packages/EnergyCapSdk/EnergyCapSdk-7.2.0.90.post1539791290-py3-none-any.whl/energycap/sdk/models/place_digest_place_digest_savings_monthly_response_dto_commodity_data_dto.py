...
class PlaceDigestPlaceDigestSavingsMonthlyResponseDTOCommodityDataDTO(Model):
    ...
    :type results:
     list[~energycap.sdk.models.PlaceDigestPlaceDigestSavingsMonthlyResponseDTOCommodityDataDTOCommodityResultsDTO]
    """
    ...
    _attribute_map = {
        ...
        'results': {'key': 'results', 'type': '[PlaceDigestPlaceDigestSavingsMonthlyResponseDTOCommodityDataDTOCommodityResultsDTO]'},
    }
    ...
    def __init__(self, commodity_code=None, commodity_info=None, commodity_id=None, common_use_unit=None, cost_unit=None, results=None):
        super(PlaceDigestPlaceDigestSavingsMonthlyResponseDTOCommodityDataDTO, self).__init__()
