...
class BillImportProfileBillImportProfileColumnMapping(Model):
    ...
    :param observations:  <span class='property-internal'>Cannot be
     Empty</span>
    :type observations:
     list[~energycap.sdk.models.BillImportProfileBillImportProfileObservation]
    """
    ...
    _attribute_map = {
        ...
        'observations': {'key': 'observations', 'type': '[BillImportProfileBillImportProfileObservation]'},
    }
    ...
    def __init__(self, date_format, account_code_column_index, start_date_column_index, end_date_column_index, vendor_code_column_index=None, pay_amount_column_index=None, billing_period_column_index=None, account_period_column_index=None, statement_date_column_index=None, due_date_column_index=None, control_code_column_index=None, invoice_number_column_index=None, meter_code_column_index=None, commodity_column_index=None, service_charge_column_index=None, ace_flag_column_index=None, vpr_flag_column_index=None, rate_column_index=None, serial_number_column_index=None, bill_note_column_index=None, observations=None):
        super(BillImportProfileBillImportProfileColumnMapping, self).__init__()
