...
class UnitUnitResponseDTO(Model):
    """UnitUnitResponseDTO.
    ...
    :type unit_info: str
    :param unit_type:
    :type unit_type: ~energycap.sdk.models.UnitUnitTypeDTO
    """
    ...
    _attribute_map = {
        ...
        'unit_type': {'key': 'unitType', 'type': 'UnitUnitTypeDTO'},
    }

    def __init__(self, unit_id=None, unit_code=None, unit_info=None, unit_type=None):
        super(UnitUnitResponseDTO, self).__init__()
