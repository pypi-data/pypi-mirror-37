...
class MeterDigestMeterDigestNormalizedYearlyResponseDTOResultsDTO(Model):
    ...
    def __init__(self, year=None, native_use=None, native_demand=None, common_use=None):
        super(MeterDigestMeterDigestNormalizedYearlyResponseDTOResultsDTO, self).__init__()
        self.year = year
