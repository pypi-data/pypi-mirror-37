...
class GHWebService(object):
    ...
    def __init__(self, green_house_service):
        self.gh_service = green_house_service
        self.url = green_house_service._url
        
    def post_greenhouse(self):
        #throttle post to every 30 sec
        gh = gh_service.green_house
        if gh.post_data == None or time() > gh.post_data.last_update + 30:
            gh_service.update_green_house()
