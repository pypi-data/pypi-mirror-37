...
class IoTGreenhouseService(object):
    ...
    def _make_components(self):
        ...
        self.servo = GHServo(self._pi, GHgpio.SERVO_PWM, self._servo_ccw_limit, self._servo_cw_limit)
        self.switches = GHSwitches(self._pi, GHgpio.SWITCH_PB, GHgpio.SWITCH_TOGGLE)
        self.temperature = GHTemperature(self._pi, self.analog.aux, self.analog.temp)
    ...
    def make_greenhouse(self, name):
        ...
        config = configparser()
        config.read_string("iot_gh.conf")
