...
// var SCRAPYD_SERVERS_length = {{ SCRAPYD_SERVERS|length }};
...
function checkCheckboxes() {
    ...
    } else if (checked_amount == SCRAPYD_SERVERS_length) {
        my$('#selected_nodes_statement').innerText = "All "+SCRAPYD_SERVERS_length+" nodes selected";
    } else {
        my$('#selected_nodes_statement').innerText = checked_amount+"/"+SCRAPYD_SERVERS_length+" nodes selected";
    }
