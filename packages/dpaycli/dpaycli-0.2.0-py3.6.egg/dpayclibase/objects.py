...
from dpaycligraphenebase.objects import GrapheneObject, isArgsThisClass
from .objecttypes import object_type
from dpaycligraphenebase.account import PublicKey
from dpaycligraphenebase.objects import Operation as GPHOperation
...
class Operation(GPHOperation):
    ...
    def _getklass(self, name):
        module = __import__("dpayclibase.operations", fromlist=["operations"])
