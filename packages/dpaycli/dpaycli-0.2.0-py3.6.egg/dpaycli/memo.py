...
import random
from dpayclibase import memo as BtsMemo
...
class Memo(object):
    """ Deals with Memos that are attached to a transfer
        ...
        :param dpaycli.account.Account from_account: Account that has sent the memo
        :param dpaycli.account.Account to_account: Account that has received the memo
        ...
        The high level memo class makes use of the dpaycli wallet to obtain keys
