...
class PolarGridHelper(Object3D):
    ...
    def __init__(self, radius=10, radials=16, circles=8, divisions=64, color1="0x444444", color2="0x888888", **kwargs):
    ...
    color1 = Color("0x444444", allow_none=False).tag(sync=True)

    color2 = Color("0x888888", allow_none=False).tag(sync=True)
