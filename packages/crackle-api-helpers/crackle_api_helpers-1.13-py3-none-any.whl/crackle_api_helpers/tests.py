...
from crackle_api_helpers.api_wrapper import (
    AuthHelpers, APIWrapper, APIWrapperAnimax, APIWrapperHelpers)
...
class TestHelpers(unittest.TestCase):
    ...
    def test_get_playlist_metadata_roku(self):
        ...
        channel_list = self.api_wrapper.get_genre_metadata_roku(
            genre='TV', genre_type='Comedy')
        channel_id = channel_list[1].get('ID')
        self.assertIsNotNone(
            self.api_wrapper.get_playlist_metadata_roku(
