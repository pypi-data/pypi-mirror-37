...
class PoolStat(object):
    ...
    def __init__(self, actual_kbyte=None, create=None, creating_num=None, data_kbyte=None, degraded_num=None, degraded_percent=None, error_kbyte=None, healthy_num=None, healthy_percent=None, omap_total_kbyte=None, omap_used_kbyte=None, omap_used_percent=None, read_bandwidth_kbyte=None, read_iops=None, read_latency_us=None, recovery_bandwidth_kbyte=None, recovery_iops=None, recovery_num=None, recovery_percent=None, total_bandwidth_kbyte=None, total_iops=None, total_kbyte=None, unavailable_num=None, unavailable_percent=None, used_kbyte=None, write_bandwidth_kbyte=None, write_iops=None, write_latency_us=None):  # noqa: E501
