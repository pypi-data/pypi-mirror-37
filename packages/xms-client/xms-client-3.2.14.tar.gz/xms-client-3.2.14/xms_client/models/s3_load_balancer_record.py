...
class S3LoadBalancerRecord(object):
    ...
    def __init__(self, create=None, description=None, group=None, host=None, https_port=None, id=None, interface_name=None, ip=None, name=None, port=None, ssl_certificate=None, status=None, update=None, vip=None, vip_mask=None, vips=None, samples=None):  # noqa: E501
