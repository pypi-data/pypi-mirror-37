...
class MappingGroupsApi(object):
    ...
    def update_client_group(self, mapping_group_id, client_group_id, **kwargs):  # noqa: E501
        """update_client_group  # noqa: E501

        update client group in mapping group  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_client_group(mapping_group_id, client_group_id, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.update_client_group_with_http_info(mapping_group_id, client_group_id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_client_group_with_http_info(mapping_group_id, client_group_id, **kwargs)  # noqa: E501
            return data

    def update_client_group_with_http_info(self, mapping_group_id, client_group_id, **kwargs):  # noqa: E501
        """update_client_group  # noqa: E501

        update client group in mapping group  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_client_group_with_http_info(mapping_group_id, client_group_id, async=True)
        >>> result = thread.get()
        ...
        if ('mapping_group_id' not in params or
                params['mapping_group_id'] is None):
            raise ValueError("Missing the required parameter `mapping_group_id` when calling `update_client_group`")  # noqa: E501
