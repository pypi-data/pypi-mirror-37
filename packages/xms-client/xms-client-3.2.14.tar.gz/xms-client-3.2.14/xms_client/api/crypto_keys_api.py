...
class CryptoKeysApi(object):
    ...
    def create_crypto_key(self, body, **kwargs):  # noqa: E501
        """create_crypto_key  # noqa: E501

        Create a crypto key  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.create_crypto_key(body, async=True)
        >>> result = thread.get()

        :param async bool
        :param CryptoKeyCreateReq body: crypto key info (required)
        ...
        if kwargs.get('async'):
            return self.create_crypto_key_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_crypto_key_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def create_crypto_key_with_http_info(self, body, **kwargs):  # noqa: E501
        """create_crypto_key  # noqa: E501

        Create a crypto key  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.create_crypto_key_with_http_info(body, async=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_crypto_key`")  # noqa: E501
