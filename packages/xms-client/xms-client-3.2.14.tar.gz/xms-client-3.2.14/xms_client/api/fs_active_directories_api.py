...
class FsActiveDirectoriesApi(object):
    ...
    def sync_fs_active_directory(self, fs_active_directory_id, **kwargs):  # noqa: E501
        """sync_fs_active_directory  # noqa: E501

        Sync a file storage active directory  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.sync_fs_active_directory(fs_active_directory_id, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.sync_fs_active_directory_with_http_info(fs_active_directory_id, **kwargs)  # noqa: E501
        else:
            (data) = self.sync_fs_active_directory_with_http_info(fs_active_directory_id, **kwargs)  # noqa: E501
            return data

    def sync_fs_active_directory_with_http_info(self, fs_active_directory_id, **kwargs):  # noqa: E501
        """sync_fs_active_directory  # noqa: E501

        Sync a file storage active directory  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.sync_fs_active_directory_with_http_info(fs_active_directory_id, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method sync_fs_active_directory" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'fs_active_directory_id' is set
        if ('fs_active_directory_id' not in params or
                params['fs_active_directory_id'] is None):
            raise ValueError("Missing the required parameter `fs_active_directory_id` when calling `sync_fs_active_directory`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/fs-active-directories/{fs_active_directory_id}:sync', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
