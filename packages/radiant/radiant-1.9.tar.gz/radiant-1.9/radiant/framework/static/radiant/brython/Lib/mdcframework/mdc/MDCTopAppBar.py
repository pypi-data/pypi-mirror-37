...
class MDCTopAppBar(MDCTemplate):
    ...
    def __new__(self, title, menu_icon='menu', items=[], short=False, collapsed=False, prominent=False, fixed=True, theme='primary', **kwargs):
        """"""
        self.element = self.render(locals(), kwargs)
    ...
    def __html__(cls, **context):
        ...
        code = """
            <header class="mdc-top-app-bar mdc-theme--{theme}-bg mdc-theme--on-{theme} {short} {collapsed} {fixed} {prominent}" style='z-index: 1;'>
