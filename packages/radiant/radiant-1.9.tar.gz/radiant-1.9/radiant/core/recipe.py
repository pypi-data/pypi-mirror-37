...
from radiant.core.logger import (logger, info, warning, error, debug, shprint, info_main)
from radiant.core.util import (urlretrieve, current_directory, ensure_dir)

# this import is necessary to keep imp.load_source from complaining :)
import radiant.core.recipes
...
class Recipe(with_metaclass(RecipeMeta)):
    ...
    def get_recipe(cls, name, ctx):
        ...
        mod = import_recipe('radiant.core.recipes.{}'.format(name), recipe_file)
...
class BootstrapNDKRecipe(Recipe):
    ...
    :class:`~radiant.core.recipe.NDKRecipe`.
    '''
