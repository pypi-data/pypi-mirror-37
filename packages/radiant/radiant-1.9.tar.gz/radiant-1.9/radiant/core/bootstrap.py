...
from radiant.core.logger import (warning, shprint, info, logger,
                                     debug, error)
from radiant.core.util import (current_directory, ensure_dir,
...
class Bootstrap(object):
    ...
    def get_bootstrap(cls, name, ctx):
        ...
        mod = importlib.import_module('radiant.core.bootstraps.{}'
                                      .format(name))
