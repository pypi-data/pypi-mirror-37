...
class Gtf_helper():
    ...
    def extract_window_from_gene_id(self, gene_ID):
        try:
            ...
            if self.find == 1:
                ...
                sys.exit('Gene not found. Please check the validity of the entered data.')
        except:
            sys.exit('I can not process the gtf file using the gene id. Please check the validity of the entered data.')
    def extract_transcripts_from_widnow(self, chr, start, end, selected_transcripts = 0):
        try:
            ...
            sys.exit('I can not process the gtf file using the genomic coordinates. Please check the validity of the entered data.')
    ...
    def extract_data_about_transcripts(self, elements_id, users_scaffold=0, users_start=0, users_end=0):
        try:
            ...
            if self.exist ==1:
                ...
                sys.exit('Transcripts not found. Please check the validity of the entered data.')
        except:
            sys.exit('I can not process the gtf file using transcripts id. Please check the validity of the entered data.')
...
class Extraction_of_sequence(Extraction_of_data):
    ...
    def extract(self):
        try:
            ...
            sys.exit('I can not process the fasta file. Please check the validity of the entered data.')
...
class Extraction_of_coverage(Extraction_of_data):
    ...
    def extract(self):
        ...
        try:
            ...
            sys.exit('I can not process the bedgraph files. Please check the validity of the entered data.')
