...
class Parameters:
    ...
    def parse_command_line(self):
        ...
        parser.add_argument('--sampledata', dest='data', action='store_true',
        ...
        parser.add_argument('-t', type=str, dest='transcript_id',
        ...
        parser.add_argument('-fa', dest='fasta_file', type=str,
                            help='<path/file.fa>  Path to the genome assembly multifasta for the sequence track.')

        parser.add_argument('-gtf', dest='gtf_file', type=str,
