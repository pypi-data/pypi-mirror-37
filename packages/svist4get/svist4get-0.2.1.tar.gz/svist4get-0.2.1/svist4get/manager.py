...
class Parameters:
    ...
    def parse_command_line(self):
        ...
        parser = argparse.ArgumentParser(prog='svist4get', description='svist4get commmand line format:', add_help= False)
            ...
            with open(self.path_to_bedgraph) as bedgraph:
                ...
                for line in bedgraph:
                    ...
                    if line[0] == self.global_parameters['scaffold'] and ((
                            self.global_parameters['end']>= int(line[1]) >= self.global_parameters['start']) or (
                            self.global_parameters['start']<= int(line[2]) <= self.global_parameters['end'])):
