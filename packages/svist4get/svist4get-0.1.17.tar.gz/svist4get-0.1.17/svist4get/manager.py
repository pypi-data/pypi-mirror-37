...
class Parameters:
    ...
    def parse_command_line(self):
        ...
        parser.add_argument("--version", "-v", action='version', version='%(prog)s 0.1.17',
        ...
        parser.add_argument('-sca', dest='aminoacid_sequence_scale',
                            choices=['large', 'small', 'auto'], metavar='', default='auto',
        ...
        parser.add_argument('-lb', dest='lvl_of_bedgraph_axis_tics', nargs='*', metavar='', default=-1, type=float,
        ...
        parser.add_argument('-bul', dest='bedgraph_upper_limit', metavar='', nargs='*', default=0,
        ...
        parser.add_argument('-bll', dest='bedgraph_lower_limit', metavar='', nargs='*', type=float, default=0,
        ...
        parser.add_argument('-hrf', dest='highlight_reading_frame', metavar='',
                            help=' <N>   Highlight a particular reading frame (+0, +1 or +2)\n', default=-1)
        ...
        parser.add_argument('-hf', dest='highlight_frame', metavar='', nargs=3, default=0,
