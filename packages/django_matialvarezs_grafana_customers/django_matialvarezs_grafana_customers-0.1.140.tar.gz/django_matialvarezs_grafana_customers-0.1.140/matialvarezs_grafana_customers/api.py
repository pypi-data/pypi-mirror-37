...
def create_datasource_influxdb(datasource_name,url,database_password,database_user,database_name,database_host,database_port):
    data = {
...
def restore_folder_permissions(folder_uid):
    ...
    res = matialvarezs_request_handler_utils.send_post_and_get_response(url=url, data=json.dumps(data), headers=settings.GRAFANA_API_HEADERS)
