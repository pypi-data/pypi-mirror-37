...
class Assetic3IntegrationRepresentationsComponentDimensionRepresentation(object):
    ...
    attribute_map = {
        ...
        'comments': 'Comments',
        'nm_sub_total': 'NMSubTotal',
        'nm_sub_total_unit': 'NMSubTotalUnit',
        'message': 'Message',
    ...
    def __init__(self, id=None, dimension_id=None, record_type=None, network_measure=None, unit=None, multiplier=None, network_measure_type=None, comments=None, nm_sub_total=None, nm_sub_total_unit=None, message=None, component_id=None, asset_id=None, last_modified_on=None, last_modified_by=None, links=None, embedded=None):  # noqa: E501
        ...
        self._comments = None
        self._nm_sub_total = None
        self._nm_sub_total_unit = None
        self._message = None
        ...
        if nm_sub_total is not None:
            self.nm_sub_total = nm_sub_total
        if nm_sub_total_unit is not None:
            self.nm_sub_total_unit = nm_sub_total_unit
    ...
    @property
    def nm_sub_total(self):
        """Gets the nm_sub_total of this Assetic3IntegrationRepresentationsComponentDimensionRepresentation.  # noqa: E501


        :return: The nm_sub_total of this Assetic3IntegrationRepresentationsComponentDimensionRepresentation.  # noqa: E501
        :rtype: float
        """
        return self._nm_sub_total

    @nm_sub_total.setter
    def nm_sub_total(self, nm_sub_total):
        """Sets the nm_sub_total of this Assetic3IntegrationRepresentationsComponentDimensionRepresentation.


        :param nm_sub_total: The nm_sub_total of this Assetic3IntegrationRepresentationsComponentDimensionRepresentation.  # noqa: E501
        :type: float
        """

        self._nm_sub_total = nm_sub_total

    @property
    def nm_sub_total_unit(self):
        """Gets the nm_sub_total_unit of this Assetic3IntegrationRepresentationsComponentDimensionRepresentation.  # noqa: E501


        :return: The nm_sub_total_unit of this Assetic3IntegrationRepresentationsComponentDimensionRepresentation.  # noqa: E501
        :rtype: str
        """
        return self._nm_sub_total_unit

    @nm_sub_total_unit.setter
    def nm_sub_total_unit(self, nm_sub_total_unit):
        """Sets the nm_sub_total_unit of this Assetic3IntegrationRepresentationsComponentDimensionRepresentation.


        :param nm_sub_total_unit: The nm_sub_total_unit of this Assetic3IntegrationRepresentationsComponentDimensionRepresentation.  # noqa: E501
        :type: str
        """

        self._nm_sub_total_unit = nm_sub_total_unit
