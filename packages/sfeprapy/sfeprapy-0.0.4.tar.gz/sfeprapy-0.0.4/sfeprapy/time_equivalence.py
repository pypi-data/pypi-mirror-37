...
from sfeprapy.time_equivalence_mc import calc_time_equiv_worker, mc_inputs_generator2
...
def plot_dist(id_, df_input, path_input_file, headers):
    ...
    for k, v in names.items():
        ...
        plt.savefig(os.path.join(os.path.dirname(path_input_file), '{} - dist - {}.png'.format(id_, v)), ppi=300)
        plt.cla()
