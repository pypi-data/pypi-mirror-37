...
class PipelineStep(object):
    ...
    def _check_outputs(self, output_vars=(), is_last=False):
        ...
        if self.outputs:
            ...
            warn('{0} {1} does not have any outputs.'.format(self._step_type, self._name), PipelineWarning)
        else: # is_last = False
            raise PipelineError('{0} {1} does not have any outputs.'.format(self._step_type, self._name))
