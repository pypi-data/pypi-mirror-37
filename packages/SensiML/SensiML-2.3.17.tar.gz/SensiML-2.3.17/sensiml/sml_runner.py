...
class SMLRunner(object):
    ...
    def __init__(self, path):
        ...
        try:
            ...
            self._get_feature_vector.argtypes = [ctypes.c_int, ctypes.POINTER(ctypes.c_uint8), ctypes.POINTER(ctypes.c_uint8)]
        except:
    ...
    def _run_with(self, run_type):
        ...
        if self._run_type != run_type:
            print("This model has already been run with {}. You will need to restart your kernal to run in this mode.".format(self._run_type))
            return False
    ...
    def get_feature_vector(self, model_index):
        ...
        self._get_feature_vector(model_index_ctype, feature_vector_ctype, ctypes.byref(feature_length_ctype))
