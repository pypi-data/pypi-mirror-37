...
class DashBoard(BaseWidget):
    ...
    def _set_project(self, option):
        ...
        if pipelines is not None:
            pipelines = ['']+sorted(list(pipelines.Name.values), key=lambda s: s.lower())
        else:
            pipelines = []
    ...
    def _on_button_clicked(self, b):
        ...
        self._widget_project.options = ['']+sorted(list(self._dsk.list_projects().Name.values), key=lambda s: s.lower())
    ...
    def _add_pipeline(self, b):
        ...
        self._widget_pipeline.options = self._widget_pipeline.options + (self._widget_new_pipeline.value,)
    ...
    def _create_widget(self, knowledgepack_level='Project'):
        ...
        self._button_clear = Button(description="Clear Output", tooltip='Clear Output Text Below Dashboard')
        ...
        login = VBox([self._button_connected,
                     HBox([self._button_clear,
