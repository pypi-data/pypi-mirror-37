...
def DAEefficiencyWithSVD(x, Deff, vif, Eeff, rank, verbose):
    """DAEefficiencyWithSVD(Eigen::MatrixXd const & x, double & Deff, double & vif, double & Eeff, int & rank, int verbose)"""
    return _oalib.DAEefficiencyWithSVD(x, Deff, vif, Eeff, rank, verbose)
...
def conference2DSD(conf, add_zeros=True):
    """
    conference2DSD(array_link conf, bool add_zeros=True) -> array_link
    conference2DSD(array_link conf) -> array_link
    """
    return _oalib.conference2DSD(conf, add_zeros)
