...
class pandasDataFrameManipulator:
    ...
    def eliminateNullFeatures(df_in, threshold):
        if self.verbose:
    ...
    def getDataFrameSegmentByReExp(df_in, list_of_columns=[], list_of_exceptions=[], use_last_lists=False, reset_index=True, drop_columns=False):
    ...
    def dropColumnsFromDataFrame(df_in, list_of_columns=[], list_of_exceptions=[], use_last_lists=False):
    ...
    def sumByReExp(df_in, result_column_name, list_of_columns=[], list_of_exceptions=[], use_last_lists=False, drop_columns=False):
    ...
    def maxByReExp(df_in, result_column_name, list_of_columns=[], list_of_exceptions=[], use_last_lists=False, drop_columns=False):
    ...
    def calculateEvolutionByRegExp(df_in, comparison_column, result_column_name, list_of_columns=[], list_of_exceptions=[], use_last_lists=False, drop_columns=False):
        ...
        if self.verbose:
            ...
            maxByReExp(df_in, list_of_columns, 'tmp_max_' + result_column_name, drop_columns=False)
            ...
            if drop_columns:
                ...
                dropColumnsFromDataFrame(df_in, [temp_column_pattern] + list_of_columns, [comparison_column_pattern]) 
