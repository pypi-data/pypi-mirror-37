...
class pandasDataFrameManipulator:
    ...
    def sumByReExp(df_in, list_of_columns=[], list_of_exceptions=[], use_last_lists=False, result_column_name, drop_columns=False):
    ...
    def maxByReExp(df_in, list_of_columns=[], list_of_exceptions=[], use_last_lists=False, result_column_name, drop_columns=False):
    ...
    def calculateEvolutionByRegExp(df_in, list_of_columns=[], list_of_exceptions=[], use_last_lists=False, drop_columns=False, comparison_column, result_column_name):
