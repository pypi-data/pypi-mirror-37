...
class WOEHelper:
    ...
    def setLabel(entry, value):
        self.labels[entry] = value


    def getInformationValue(df_in, independent_feature, dependent_feature):
    ...
    def WOEvaluation(df_in, woe_evaluation_var, target):
    ...
    def catSplit(df_in, var_name, in_cut_points):
