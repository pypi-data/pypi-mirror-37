...
class TestBar(TestCase):
    ...
    def test_select(self):
        ...
        objs = TestBar.db.select(Bar.createAdhoc(AdhocKeys({'heading': 98, 'speed': 2.3, 'signal': 'X'})))
        self.assertEqual(len(objs), 1)
        self.assertEqual(objs[0].getId(), 98)
