...
def workers_register(master_endpoint, metafile, workdir, assume_cpu, assume_gpu):
    ...
    register(master_endpoint, metafile, workdir, cpu_count, gpu_count, gpu_count)
    return
...
def main():
    ...
    # Register first...
    if not registered:
        workers_register(master_endpoint, metafile, workdir, assume_cpu, assume_gpu)
