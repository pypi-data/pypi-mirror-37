...
class ECMmodel(object):
    ...
    def FromSBtab(sbtabdoc, ecf_params=None):
        bound_sbtab = sbtabdoc.get_sbtab_by_name('ConcentrationConstraint')
        bound_unit = bound_sbtab.get_attribute('Unit')
        
        flux_sbtab = sbtabdoc.get_sbtab_by_name('RelativeFlux')
        ...
        df_dict = {sbtab.table_name : sbtab.to_data_frame()
    ...
    def AddValidationData(self, validate_sbtabdoc):
        self._met_conc_unit = validate_sbtabdoc.get_sbtab_by_name('Concentration').get_attribute('Unit')
        self._enz_conc_unit = validate_sbtabdoc.get_sbtab_by_name('EnzymeConcentration').get_attribute('Unit')
        self._val_df_dict = {sbtab.table_name : sbtab.to_data_frame()
