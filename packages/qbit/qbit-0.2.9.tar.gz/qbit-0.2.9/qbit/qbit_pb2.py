...
_SOLVERTIMING_DETAILEDENTRY.has_options = True
_SOLVERTIMING_DETAILEDENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
...
_QBIT = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    input_type=_COMPAREREQUEST,
    output_type=_COMPARISONRESULT,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\031\"\024/v1/gms/comparebench:\001*')),
  ),
  _descriptor.MethodDescriptor(
    name='Hobo2Qubo',
