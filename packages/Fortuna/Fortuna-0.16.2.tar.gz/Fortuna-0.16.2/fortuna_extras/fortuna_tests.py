...
if __name__ == "__main__":
    t0 = datetime.now()
    print("Fortuna 0.16.2 Sample Distribution and Performance Test Suite\n")
    ...
    distribution_timer(mostly.mostly_flat, call_sig="mostly.mostly_flat()")
    ...
    print(f"{'-' * 73}\n")
    distribution_timer(randint_dice, r, s, call_sig=f"Slow Base Case:\nrandint_dice({r}, {s})"),
