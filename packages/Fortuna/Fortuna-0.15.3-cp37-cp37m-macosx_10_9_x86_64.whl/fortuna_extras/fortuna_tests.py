...
def distribution_timer(func: staticmethod, *args, call_sig="f(x)", max_distribution=25):
    num_cycles = 100000
...
def floor_dice(rolls, sides):
    """ Base Case: Fast but poor distribution, can have platform dependant bias like c rand(). """
    total = rolls
...
if __name__ == "__main__":
    ...
    t0 = datetime.now()
    print("Fortuna 0.15.3 Sample Distribution and Performance Test Suite\n")
    ...
    print(f"{'-' * 73}\n")
    print('cumulative_weighted_table = [(7, "Apple"), (11, "Banana"), (13, "Cherry"), (23, "Grape"), '
          '(26, "Lime"), (30, "Orange")]')
    print("cumulative_weighted_choice = CumulativeWeightedChoice(cumulative_weighted_table)\n")
    ...
    print('relative_weighted_table = [(7, "Apple"), (4, "Banana"), (2, "Cherry"), (10, "Grape"), '
          '(3, "Lime"), (4, "Orange")]')
    print("relative_weighted_choice = RelativeWeightedChoice(relative_weighted_table)\n")
