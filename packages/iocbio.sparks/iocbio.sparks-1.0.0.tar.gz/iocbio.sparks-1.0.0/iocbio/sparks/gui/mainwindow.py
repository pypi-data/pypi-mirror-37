...
from ..io.export import Export2xls
...
class MainGUI(QMainWindow):
    ...
    def __init__(self, experiment_id, filename, comment, database, data, dx, dt, transposed):
        ...
        self.export_experiment_browser.sigExportRequest.connect(self.export_experiments)
        # }
    ...
    def export_experiments(self, files_to_export, database, out_file, ftype):
