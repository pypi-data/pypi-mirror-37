...
class TenMinuteEmail(object):
    """
    10分钟邮箱(https://10minutemail.com/10MinuteMail/index.html)
        simple use:
            _ = TenMinuteEmail()
            ...
            print('email_message_count: {}个'.format(_._get_email_message_count()))
    ...
    def _get_email_address(self) -> str:
        ...
        return self._get_url_body(url=url)
    ...
    def _get_email_message_list(self) -> list:
        ...
        data = json_2_dict(self._get_url_body(url=url), default_res=[])
