...
from setuptools import setup, Command, Extension, Distribution, find_packages
...
setup(
    ...
    install_requires = ['pyfits>=3.2', 'numpy>=1.2', 'scipy>=0.7', 'pyephem>=3.7.5', 'aipy>=1.0', 'pytz>=2011k'], 
    extras_require = {":python_version<'2.7'": ["unittest2"]}, 
