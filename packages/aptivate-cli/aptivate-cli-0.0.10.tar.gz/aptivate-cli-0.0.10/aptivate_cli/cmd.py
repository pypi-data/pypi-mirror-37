...
from aptivate_cli.settings import APTIVATE_CLI_MYSQL, APTIVATE_CLI_SUDO
...
def playbook_run_project_play(config: Config, env: str) -> None:
    ...
    if env == 'dev':
        ...
        extravars = {
            ...
            'ansible_become_pass': config.env_vars[APTIVATE_CLI_SUDO],
            'mysql_root_password': config.env_vars[APTIVATE_CLI_MYSQL],
        }
