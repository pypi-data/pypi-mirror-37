...
from aptivate_cli.settings import (
    ...
    APTIVATE_CLI_MYSQL_PASS, APTIVATE_CLI_PASS_DIR, APTIVATE_CLI_SSH_USER,
    APTIVATE_CLI_SUDO_PASS, IS_GITLAB_CI, PROJECT_PLAY_REPOSITORY_URL
)
