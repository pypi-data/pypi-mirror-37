...
try:
    ...
    class AlgorithmIODataType(Enum):
        ...
        BINARY_ENTRT_NUM_INPUT = BinaryEntryNumInputType
        ...
        def deduceType(cls, input_value):
            ...
            try:
                if not type_validate:
                    binaryEntryNumType = AlgorithmIODataType.BINARY_ENTRT_NUM_INPUT.value()
                    binaryEntryNumType.validate(input_value)
                    type_validate = True
                    return AlgorithmIODataType.BINARY_ENTRT_NUM_INPUT.value
            except (TypeError, BaseError):
                type_validate = False
