...
class EC(gateway.Device):
    ...
    def set_opt(self, opts):
        ...
        return int( self.set_value('ec.optAB', int(self.get_opt() | opts)))
    ...
    def seta_opt(self, opts):
        ...
        return int( self.set_value('ec.optA', int(self.geta_opt() | opts)))
    ...
    def setb_opt(self, opts):
        assert(type(opts) == self.ChannelOpts)
        return int( self.set_value('ec.optB', int(self.getb_opt() | opts)))
